...
if text == 'المعاني' and database:get('IRAQ:'..bot_id..'lock_geam'..msg.chat_id_) then
...
taha = (database:get('IRAQ:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('IRAQ:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
