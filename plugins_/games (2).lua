...
if tahadevstorm:get(DEVSTOR.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
tahadevstorm:del(DEVSTOR.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = tahadevstorm:get(DEVSTOR..'SET:ID:USER'..msg.chat_id_)  
taha = "\n📬*¦ روح خالي 😉 تم اضافة له { "..text:match("^(%d+)$").." }* رساله"
storm_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
tahadevstorm:incrby(DEVSTOR..'user:messages:'..msg.chat_id_..':'..GET_IDUSER,text:match("^(%d+)$"))  

end
tahadevstorm:del(DEVSTOR.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end

if tahadevstorm:get(DEVSTOR.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^(%d+)$") then
if tonumber(text:match("^(%d+)$")) > 50000 then
taha = "*📬¦ لا تستطيع اضافة اكثر من 1000 نقطه\n*"
storm_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
tahadevstorm:del(DEVSTOR.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = tahadevstorm:get(DEVSTOR..'SET:ID:USER:NUM'..msg.chat_id_)  
taha = "\n📬*¦ طكو طكو عمي 😻 تم اضافة له { "..text:match("^(%d+)$").." }* نقطه"
storm_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
tahadevstorm:incrby(DEVSTOR..'NUM:GAMES'..msg.chat_id_..GET_IDUSER, text:match("^(%d+)$"))  
end
tahadevstorm:del(DEVSTOR.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
end
...
if tahadevstorm:get(DEVSTOR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
storm_sendMsg( msg.chat_id_, msg.id_, 1,"*📬¦ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *\n", 1, "md")    
return false  end 
local GETNUM = tahadevstorm:get(DEVSTOR.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
tahadevstorm:del(DEVSTOR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
tahadevstorm:del(DEVSTOR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
tahadevstorm:incrby(DEVSTOR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,5)  
storm_sendMsg( msg.chat_id_, msg.id_, 1,'*🔖¦ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸¦ تم اضافة { 5 } من النقاط *\n', 1, "md")    
elseif tonumber(NUM) ~= tonumber(GETNUM) then
tahadevstorm:incrby(DEVSTOR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(tahadevstorm:get(DEVSTOR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
tahadevstorm:del(DEVSTOR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
tahadevstorm:del(DEVSTOR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
tahadevstorm:set(DEVSTOR.."GAMES:NUM"..msg.chat_id_,Num) 
TEST = '*\n📮¦ اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..'⚠¦ ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..'🔖¦ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ \n🎊¦ الفائز سيحصل على { 5 } من النقود \n💥*'
storm_sendMsg( msg.chat_id_, msg.id_, 1, TEST, 1, "md") 
tahadevstorm:setex(DEVSTOR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
tahadevstorm:set(DEVSTOR..'SET:ID:USER'..msg.chat_id_,ID_USER)  
tahadevstorm:setex(DEVSTOR.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📊¦ ارسل لي عدد الرسائل الذي تريده*\n', 1, 'md') 
end
...
return false  end 
local ID_USER = MSG_TEXT[2]
tahadevstorm:set(DEVSTOR..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
tahadevstorm:setex(DEVSTOR.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
storm_sendMsg(msg.chat_id_, msg.id_, 1,'*📊¦ ارسل لي عدد النقاط الذي تريده*\n', 1, 'md') 
end
