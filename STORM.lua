...
NAMEBOT = (tahadevIRAQ:get(DEVSTOR..'IRAQ:name') or 'ستورم')
...
local hash = tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',msg.sender_user_id_)  
...
local hash = tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,msg.sender_user_id_)    
...
local hash = tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,msg.sender_user_id_)    
...
local hash = tahadevIRAQ:sismember(DEVSTOR..'SET:BAN'..msg.chat_id_,msg.sender_user_id_)    
if hash or  is_devtaha(msg) or is_sudo(msg) or is_owner(msg) then    
return true    
else    
return false    
...
function is_mod(msg) 
local hash = tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,msg.sender_user_id_)    
...
local hash = tahadevIRAQ:sismember(DEVSTOR..'vip:groups',msg.sender_user_id_) 
if hash or  is_devtaha(msg) then 
return true 
else 
return false 
...
local hash = tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,msg.sender_user_id_) 
...
local hash = tahadevIRAQ:sismember(DEVSTOR..'mepar',msg.sender_user_id_) 
...
local hash =  tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..chat,user) 
if hash then return true 
else 
return false 
end end
function is_gban(chat,user) 
local hash =  tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',user) 
if hash then 
return true 
else 
return false 
...
local var = true
if tahadevIRAQ:get(DEVSTOR..'add:ch:id') then
tahaid = tahadevIRAQ:get(DEVSTOR..'add:ch:id')
tahauser = tahadevIRAQ:get(DEVSTOR..'add:ch:username')
...
var = false
if tahadevIRAQ:get(DEVSTOR..'text:ch:user') then
local textchuser = tahadevIRAQ:get(DEVSTOR..'text:ch:user')
...
local sudoe = tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user) 
local noow = tahadevIRAQ:sismember(DEVSTOR..'moder'..chat,user) 
...
local moder =  tahadevIRAQ:sismember(DEVSTOR..'modergroup'..chat,user) 
local mod tahadevIRAQ:sismember(DEVSTOR..'mods:'..chat,user) 
...
tahadevIRAQ:set(DEVSTOR.."user:Name"..id, "@"..username)
print('\27[30;35m»» USERNAME IS SAEVE ↓\n»» @'..data.username_..'\n\27[1;37m') else
tahadevIRAQ:del(DEVSTOR.."user:Name"..id)
print('»» USERNAME IS NOT SAEVE') end
if data.type_.ID == "UserTypeBot" then
tahadevIRAQ:del(DEVSTOR.."user:Name"..id) end
...
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user_id) then
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'moder'..chat_id,user_id) then
t = 'المنشئ'
elseif tahadevIRAQ:sismember(DEVSTOR..'modergroup'..chat_id,user_id) then
t = 'المدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..chat_id,user_id) then
t = 'الادمن'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:groups',user_id) then
t = 'المميز عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:group'..chat_id,user_id) then
t = 'المميز'
else
t = ' '
end
...
if tahadevIRAQ:sismember(DEVSTOR..'modergroup'..chat_id,user_id) then
t = 'المدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..chat_id,user_id) then
t = 'الادمن'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:group'..chat_id,user_id) then
...
tahadevIRAQ:del(DEVSTOR.."lock:user:name"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:hashtak"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Cmd"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Link"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:forward"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Keyboard"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:geam"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Photo"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Animation"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Video"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Audio"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:vico"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Sticker"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Document"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Unsupported"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Markdaun"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Contact"..chat_id)  tahadevIRAQ:del(DEVSTOR.."lock:Spam"..chat_id)
end
local function add_lockal(chat_id)
tahadevIRAQ:set(DEVSTOR.."lock:Bot:kick"..chat_id,'del')  tahadevIRAQ:set(DEVSTOR..'lock:tagservrbot'..chat_id,true)   tahadevIRAQ:set(DEVSTOR.."lock:user:name"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:hashtak"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Cmd"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Link"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:forward"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Keyboard"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:geam"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Photo"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Animation"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Video"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Audio"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:vico"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Sticker"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Document"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Unsupported"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Markdaun"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Contact"..chat_id,'del')    tahadevIRAQ:set(DEVSTOR.."lock:Spam"..chat_id,'del')  
end
function rem_group(chat_id) 
tahadevIRAQ:srem(DEVSTOR..'bot:gpsby:id',chat_id) tahadevIRAQ:del(DEVSTOR.."test:group"..chat_id)   tahadevIRAQ:srem(DEVSTOR.."bot:gps:id", chat_id) tahadevIRAQ:del(DEVSTOR.."add:bot:group"..chat_id,true) 
rem_lockal(chat_id) 
end
function add_group(chat_id) 
tahadevIRAQ:sadd(DEVSTOR..'bot:gpsby:id',chat_id) tahadevIRAQ:sadd(DEVSTOR.."botgps",chat_id)  tahadevIRAQ:set(DEVSTOR.."test:group"..chat_id,'IRAQ')    tahadevIRAQ:set(DEVSTOR.."add:bot:group"..chat_id, true)   
add_lockal(chat_id)
end
...
local names = tahadevIRAQ:smembers(DEVSTOR..'filters:'..msg.chat_id_)  local var = false for i=1, #names do  if names[i] == value and not is_vipgroup(msg) then  var = true      end end return var  
end 
function is_muted(chat,user)
local hash =  tahadevIRAQ:sismember(DEVSTOR..'mutes'..chat,user) if hash then return true else return false end 
end
...
local sudoe = tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user) local vipss = tahadevIRAQ:sismember(DEVSTOR..'vip:groups',user)  local monh = tahadevIRAQ:sismember(DEVSTOR..'modergroup'..chat,user)  local noow = tahadevIRAQ:sismember(DEVSTOR..'moder'..chat,user)  local nomo = tahadevIRAQ:sismember(DEVSTOR..'mods:'..chat,user)  local novip2 = tahadevIRAQ:sismember(DEVSTOR..'vip:group'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or monh  or noow or nomo  or novip2 then  return true  else  return false  end  
end 
function IRAQ2(chat,user) 
local sudoe = tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user) local vipss = tahadevIRAQ:sismember(DEVSTOR..'vip:groups',user)  local noow = tahadevIRAQ:sismember(DEVSTOR..'moder'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or vipss or noow  then  return true else  return false end 
end 
function IRAQ3(chat,user) 
local sudoe = tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user) local noow = tahadevIRAQ:sismember(DEVSTOR..'moder'..chat,user)  if tonumber(SUDO) == tonumber(user) or sudoe or monh   then return true else return false end 
end 
function IRAQ4(chat,user) 
local sudoe = tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user) local noow = tahadevIRAQ:sismember(DEVSTOR..'moder'..chat,user)  local monh = tahadevIRAQ:sismember(DEVSTOR..'modergroup'..chat,user)     local memr = tahadevIRAQ:sismember(DEVSTOR..'mepar',user)    if tonumber(SUDO) == tonumber(user) or sudoe or monh or memr or noow then     return true     else     return false     end     
end 
function getInputFile(file) 
...
tdcli_function ({ ID = "GetChannelFull",channel_id_ = getChatId(GroupID).ID },function(arg,tah)   tahadevIRAQ:set(DEVSTOR.."numgrop"..GroupID,tah.member_count_) end,nil)  return tahadevIRAQ:get(DEVSTOR.."numgrop"..GroupID)   
end
local function title_name(GroupID) 
pcall(tdcli_function({ID ="GetChat",chat_id_=GroupID },function(arg,data)  tahadevIRAQ:set(DEVSTOR..'group:name'..GroupID,data.title_)  end,nil)) return tahadevIRAQ:get(DEVSTOR..'group:name'..GroupID)  
end
...
local get_id = text local get_id = get_id:gsub('IDGET',msg.sender_user_id_) local get_id = get_id:gsub('USERGET',USERNAME_GET) local get_id = get_id:gsub('RTBGET',t) local get_id = get_id:gsub('RTGGET',rtpa) local get_id = get_id:gsub('MSGGET',tonumber(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1)) local get_id = get_id:gsub('TFGET',formsgg(tonumber(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1))) local get_id = get_id:gsub('PHOTOGET',taha.total_count_) local get_id = get_id:gsub('NKOGET',nko)
return get_id 
end
...
tdcli_function ({ID = "GetChannelMembers", channel_id_ = getChatId(chat_id).ID,filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100 },function(arg,data)  local admins = data.members_ for i=0 , #admins do  if data.members_[i].status_.ID == "ChatMemberStatusCreator" then owner_id = admins[i].user_id_  tahadevIRAQ:sadd(DEVSTOR..'moder'..chat_id,owner_id)   tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_ },function(arg,b)   if b.username_ == true then  tahadevIRAQ:set(DEVSTOR.."user:Name"..b.id_,"@"..b.username_) end end,nil)    end  if data.members_[i].bot_info_ == false and data.members_[i].status_.ID == "ChatMemberStatusEditor" then  tahadevIRAQ:sadd(DEVSTOR..'mods:'..chat_id,admins[i].user_id_)   tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_ },function(arg,b)   if b.username_ == true then  tahadevIRAQ:set(DEVSTOR.."user:Name"..b.id_,"@"..b.username_) end end,nil)    else  tahadevIRAQ:srem(DEVSTOR..'mods:'..chat_id,admins[i].user_id_)   end end end,nil)     
end
...
tahadevIRAQ:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,msg.sender_user_id_) 
else
IRAQmonshn(msg.chat_id_, msg.sender_user_id_, msg.id_, '📮¦ العضــو » ( '..CatchName(data.first_name_,20)..' )\n📬¦ قام بالتكرار هنا وتم تقييده \n' , 14, utf8.len(data.first_name_)) 
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
tahadevIRAQ:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,msg.sender_user_id_) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "md")  
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_) 
else
IRAQmonshn(msg.chat_id_, msg.sender_user_id_, msg.id_, '📮¦ العضــو » ( '..CatchName(data.first_name_,20)..' )\n📬¦ قام بالتكرار هنا وتم كتمه \n' , 14, utf8.len(data.first_name_))  
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_) 
end
...
if msg.content_.ID == "MessageChatAddMembers" and not tahadevIRAQ:get(DEVSTOR..'lock:klsh:add'..bot_id) then   
...
if not tahadevIRAQ:get(DEVSTOR..'lock:bot:free'..bot_id) then
...
if tahadevIRAQ:sismember(DEVSTOR..'bot:gps:id',msg.chat_id_) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ المجموعه تم تفعيلها بالتاكيد \nꪜ*', 1, 'md')
tahadevIRAQ:set(DEVSTOR.."add:bot:group"..msg.chat_id_, true) 
else
addmod(msg.chat_id_) 
if ( data.member_count_ > tonumber(tahadevIRAQ:get(DEVSTOR..'setadd:bot'..bot_id) or 100) ) then
test = '*📮¦ تـم تفعيــل المجموعه بـنجـاح 🍃\n📬¦ تم ترقية المنشئ والادمنيه *\n\nꪜ'
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
tahadevIRAQ:sadd(DEVSTOR..'moder'..msg.chat_id_,msg.sender_user_id_)  
tahadevIRAQ:sadd(DEVSTOR..'add:num'..msg.sender_user_id_,msg.chat_id_) 
tahadevIRAQ:set(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
tahadevIRAQ:sadd(DEVSTOR..'bot:gpsby:id', msg.chat_id_)   
tahadevIRAQ:sadd(DEVSTOR..'bot:gpsby:id:add', msg.chat_id_)   
tahadevIRAQ:sadd(DEVSTOR.."botgps", msg.chat_id_)  
tahadevIRAQ:sadd(DEVSTOR.."bot:gps:id", msg.chat_id_)  
else
local taha = tahadevIRAQ:get(DEVSTOR..'setadd:bot'..bot_id)
...
tahadevIRAQ:del(DEVSTOR.."test:group" .. msg.chat_id_)
end
if data.member_count_ > tonumber(tahadevIRAQ:get(DEVSTOR..'setadd:bot'..bot_id) or 100) and not is_devtaha(msg) then    
local numadd = tahadevIRAQ:scard(DEVSTOR..'add:num'..msg.sender_user_id_)
...
tahadevIRAQ:set(DEVSTOR.."test:group"..msg.chat_id_,'IRAQ')   
end  
if text == 'تعطيل' and add_in_ch(msg) and is_sudo(msg) then      
if not tahadevIRAQ:sismember(DEVSTOR..'bot:gps:id',msg.chat_id_) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ المجموعه تم تعطيــلها بالتاكيد \nꪜ*', 1, 'md')
tahadevIRAQ:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
tahadevIRAQ:del(DEVSTOR.."test:group" .. msg.chat_id_)
else
test = '*📮¦ تـم تعطيــل المجموعه بـنجـاح 🍃 *\n\nꪜ'
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
tahadevIRAQ:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
tahadevIRAQ:srem(DEVSTOR..'bot:gpsby:id', msg.chat_id_)   
tahadevIRAQ:srem(DEVSTOR.."bot:gps:id", msg.chat_id_)  
tahadevIRAQ:srem(DEVSTOR.."botgps", msg.chat_id_)  
tahadevIRAQ:srem(DEVSTOR..'add:num'..msg.sender_user_id_,msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR.."test:group" .. msg.chat_id_)
if not is_devtaha(msg) then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID}, function(arg,data)  
...
tahadevIRAQ:incr(DEVSTOR..'groupmsg:'..msg.chat_id_..':') 
tahadevIRAQ:incr(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) 
tahadevIRAQ:incr(DEVSTOR..'msg:chat:'..msg.chat_id_..':') 
tahadevIRAQ:incr(DEVSTOR..'msg:user:'..msg.chat_id_..':'..msg.sender_user_id_)
if msg.send_state_.ID == "MessageIsSuccessfullySent" then return false  end end
if msg.can_be_deleted_ == true and not is_mod(msg) then   tdcli_function ({ ID = "GetUser", user_id_ = msg.sender_user_id_ },function(arg,data)  if data.username_ == true then tahadevIRAQ:set(DEVSTOR.."user:Name"..msg.sender_user_id_,"@"..data.username_) end end,nil)
if tahadevIRAQ:get(DEVSTOR..'add:mepr:'..msg.chat_id_) and tonumber(tahadevIRAQ:scard(DEVSTOR..'addedtaha:'..msg.sender_user_id_)) == tonumber(tahadevIRAQ:get(DEVSTOR..'setadd:'..msg.chat_id_)) then  
tahadevIRAQ:sadd(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_)  
tahadevIRAQ:del(DEVSTOR.."addedtaha:"..msg.sender_user_id_)  
tahadevIRAQ:srem(DEVSTOR..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
tdcli_function ({
ID = "GetUser",
user_id_ = msg.sender_user_id_
},function(arg,data) 
if data.username_ then
IRAQ_sendMsg(msg.chat_id_,msg.id_,1,'*📬¦ العضو ↫ ❪*[@'..data.username_..']*❫*\n*💠¦ قمت باضافه ❪'..tonumber(tahadevIRAQ:get(DEVSTOR..'setadd:'..msg.chat_id_))..'❫* اعضاء \n*📮¦ الان يمكنك الدردشه هنا* \n💥',1,'md')  
else
taha = '📬¦ العضو ↫ ❪'..data.id_..'❫\n💠¦ قمت باضافه ❪'..tonumber(tahadevIRAQ:get(DEVSTOR..'setadd:'..msg.chat_id_))..'❫ اعضاء \n📮¦ الان يمكنك الدردشه هنا \n🍃'
IRAQmonshn(msg.chat_id_, data.id_, 0, taha, 13, utf8.len(data.id_))  
end
end,nil)
elseif msg.content_.text_ and tahadevIRAQ:get(DEVSTOR..'add:mepr:'..msg.chat_id_) and not tahadevIRAQ:sismember(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) and not tahadevIRAQ:sismember(DEVSTOR..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_) then  
if tonumber(tahadevIRAQ:scard(DEVSTOR..'addedtaha:'..msg.sender_user_id_)) ~= tonumber(tahadevIRAQ:get(DEVSTOR..'setadd:'..msg.chat_id_)) then  
tahadevIRAQ:sadd(DEVSTOR..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
local mustadd = (tahadevIRAQ:get(DEVSTOR..'setadd:'..msg.chat_id_) or '0')  
tdcli_function ({
ID = "GetUser",
user_id_ = msg.sender_user_id_
},function(arg,data) 
...
for i=0,#mem_id do  
if tahadevIRAQ:get(DEVSTOR..'add:mepr:'..msg.chat_id_) then  
if not tahadevIRAQ:sismember(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) then  
if mem_id[i].username_ and mem_id[i].username_:match("[Bb][Oo][Tt]$") then  
return false  
else  
tahadevIRAQ:sadd(DEVSTOR..'addedtaha:'..msg.sender_user_id_,mem_id[i].id_)  
end  
end  
end  
end  
end  
if tahadevIRAQ:get(DEVSTOR..'add:mepr:'..msg.chat_id_) and not tahadevIRAQ:sismember(DEVSTOR..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) then  
...
if tahadevIRAQ:get(DEVSTOR..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) then 
...
tahadevIRAQ:del(DEVSTOR..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) 
return false  end
...
chat_type = 'super'
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,data)   tahadevIRAQ:set(DEVSTOR..'group:name'..msg.chat_id_,data.title_) end,nil) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  if data.username_ == true then tahadevIRAQ:set(DEVSTOR.."user:Name"..msg.sender_user_id_,"@"..data.username) end end,nil) 
if msg.can_be_deleted_ == true then
end
elseif id:match('^(%d+)') then 
chat_type = 'user' 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  if data.username_ == true then tahadevIRAQ:set(DEVSTOR.."user:Name"..msg.sender_user_id_,"@"..data.username) else tahadevIRAQ:del(DEVSTOR.."user:Name"..msg.sender_user_id_)  end end,nil) 
tahadevIRAQ:sadd(DEVSTOR.."usersbot",msg.chat_id_)   
else 
chat_type = 'group' 
...
local text = msg.content_.text_
if msg.content_.ID == "MessageChatAddMembers" then 
tahadevIRAQ:incr(DEVSTOR..'add:mempar'..msg.chat_id_..':'..msg.sender_user_id_) 
end
if tahadevIRAQ:get(DEVSTOR..'viewchannel'..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR..'viewchannel'..msg.sender_user_id_)
return false  end 
...
tahadevIRAQ:del(DEVSTOR..'viewchannel'..msg.sender_user_id_) end end
if text then   
if is_filter(msg,text) then    
delete_msg(msg.chat_id_,{[0] = msg.id_})        
return false end   
end  
if tahadevIRAQ:get(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
changeChatMemberStatus(ch, bot_id, "Left")
return false  end
local nummsg = tonumber(tahadevIRAQ:get(DEVSTOR..'groupmsg:'..ch..':')) 
local nummsgg = tahadevIRAQ:get(DEVSTOR..'groupmsg:'..ch..':') 
...
if tahadevIRAQ:get(DEVSTOR.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
tahadevIRAQ:set(DEVSTOR..'add:ch:id',data.id_)
tahadevIRAQ:set(DEVSTOR..'add:ch:username','@'..data.type_.channel_.username_)
else
...
if tahadevIRAQ:get(DEVSTOR.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
tahadevIRAQ:set(DEVSTOR..'text:ch:user',texxt)
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ تم تغيير رسالة الاشتراك بنجاح *\n✓', 1, 'md')
end
if tahadevIRAQ:get(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local ch = string.match(text, "(-%d+)") 
...
if tahadevIRAQ:get(DEVSTOR..'group:name'..ch) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📮*¦* رابط المجموعه \n📬*¦* '..tahadevIRAQ:get(DEVSTOR..'group:name'..ch)..' \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🍃*¦* ['..(res.result or '..')..']', 1, 'md')    
else
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'💠*¦* رابط المجموعه \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n['..(res.result or '..')..']', 1, 'md')    
end
tahadevIRAQ:set(DEVSTOR.."numgrop"..ch,data.member_count_) 
tdcli_function({ID ="GetChat",chat_id_=ch},function(arg,ata) tahadevIRAQ:set(DEVSTOR..'group:name'..ch,ata.title_) end,nil)
end
end    
getChannelFull(ch, taha, {chat_id=ch,msg_id=msg.id})    
end 
if tahadevIRAQ:get(DEVSTOR..'namebot:witting'..msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR..'namebot:witting'..msg.sender_user_id_) 
return false  end 
tahadevIRAQ:del(DEVSTOR..'namebot:witting'..msg.sender_user_id_) 
tahadevIRAQ:set(DEVSTOR..'IRAQ:name',text) 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*♻¦* تم تغير اسم البوت \n",1, 'md')  
end 
if tahadevIRAQ:get(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local welcome = text:match("(.*)")  
tahadevIRAQ:set(DEVSTOR..'welcome:'..msg.chat_id_,welcome) 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'\n📬*¦* تم وضع الترحيب \n', 1, 'md')    
end
if tahadevIRAQ:get(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
tahadevIRAQ:set(DEVSTOR..'setadd:bot'..bot_id,numadded)  IRAQ_sendMsg(msg.chat_id_, msg.id_,  1, "📬*¦* تم وضع عدد الاضافه *{ "..numadded..' }*', 1, 'md')  
end
if tahadevIRAQ:get(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  end 
tahadevIRAQ:del(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if tahadevIRAQ:get(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  end 
tahadevIRAQ:del(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  local pro = tonumber(text:match("(%d+)")) local function myprofile(extra, result, success) if result.total_count_ == 0 then IRAQ_sendMsg(msg.chat_id_, msg.id_,  1, '*🔖¦* عذرا انت لا تمتلك صور في البروفايل\n', 1, 'md') else if result.total_count_ >= pro then if result.photos_[0] then sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_, '\n🌄¦ صورتك رقم  '..pro..' \n📋¦ عدد صورك  '..result.total_count_..' \n📊¦ حجم صورتك  '..result.photos_[0].sizes_[1].photo_.size_..' ') end else IRAQ_sendMsg(msg.chat_id_, msg.id_,  1, '\n*📛¦* انت لا تمتلك صوره رقم  *{'..pro..'}*\n*🌁¦* عدد صورك هي *{'..result.total_count_..'}*', 1, 'md')  end end end getUserProfilePhotos(msg.sender_user_id_, pro-1, 1000, myprofile)  end
if tahadevIRAQ:get(DEVSTOR.."link:group"..msg.chat_id_) == 'setlinkwai' and is_mod(msg) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."link:group" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else  
...
tahadevIRAQ:set(DEVSTOR..hash,glink)   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦* تم حفظ الرابط الخاص بالمجموعه', 1, 'md')  
end   
end 
end
if tahadevIRAQ:get(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للمجموعات *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local gps = tahadevIRAQ:scard(DEVSTOR..'bot:gpsby:id')   
local list = tahadevIRAQ:smembers(DEVSTOR..'botgps')   
...
if tahadevIRAQ:get(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للكل *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local list = tahadevIRAQ:smembers(DEVSTOR..'botgps')   
for k,v in pairs(list) do  
...
local list = tahadevIRAQ:smembers(DEVSTOR..'usersbot')   
for k,v in pairs(list) do  
forwardMessages(v, msg.chat_id_, {[0] = msg.id_}, 1)  
end   
end 
local gpspv = tahadevIRAQ:scard(DEVSTOR..'usersbot')   
local gps = tahadevIRAQ:scard(DEVSTOR..'bot:gpsby:id')   
...
if tahadevIRAQ:get(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_,msg.id_ , 1, "*📬¦ تم الغاء الاذاعه بالتوجيه للخاص *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  end 
if msg.forward_info_ then 
local gps = tahadevIRAQ:scard(DEVSTOR..'usersbot')   
local list = tahadevIRAQ:smembers(DEVSTOR..'usersbot')   
for k,v in pairs(list) do  
forwardMessages(v, msg.chat_id_, {[0] = msg.id_}, 1)  
end   
...
if tahadevIRAQ:get(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للمجموعات *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else 
local gps = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id') 
for k,v in pairs(list) do 
...
if tahadevIRAQ:get(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للكل *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)  
else  
local gps = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id") or 0  
if msg.content_.text_ then
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id') 
...
local gpsv = tahadevIRAQ:scard(DEVSTOR.."usersbot") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = tahadevIRAQ:smembers(DEVSTOR..'usersbot') 
for k,v in pairs(list) do 
...
if tahadevIRAQ:get(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الاذاعه للمشتركين *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else 
local gps = tahadevIRAQ:scard(DEVSTOR.."usersbot") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = tahadevIRAQ:smembers(DEVSTOR..'usersbot') 
for k,v in pairs(list) do 
...
if tahadevIRAQ:get(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  end 
local rules = msg.content_.text_ tahadevIRAQ:set(DEVSTOR.."rules:group" .. msg.chat_id_, rules) IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦*تم حفظ القوانين ✔",  1, "md") end  tahadevIRAQ:del(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
if tahadevIRAQ:get(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local dev = text:match("(.*)") tahadevIRAQ:set(DEVSTOR.."dev", dev)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📛¦* تم وضع كليشه المطور \n', 1, 'md')   
end
if tahadevIRAQ:get(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
local msgofstart = text:match("(.*)")  
tahadevIRAQ:set(DEVSTOR.."start:msgofstart1", msgofstart)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📛¦* تم وضع كليشه ستارت \n', 1, 'md')   
end

if tahadevIRAQ:get(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) 
return false  end 
tahadevIRAQ:del(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_) 
local pvstart = text:match("(.*)") 
tahadevIRAQ:set(DEVSTOR.."pvstart", pvstart)  
...
if not tahadevIRAQ:get(DEVSTOR..'START:STOP'..msg.sender_user_id_) then
...
tahadevIRAQ:sadd(DEVSTOR.."usersbot",msg.chat_id_)   
local start = tahadevIRAQ:get(DEVSTOR.."start:msgofstart1")  
if start then 
...
tahadevIRAQ:setex(DEVSTOR..'START:STOP'..msg.sender_user_id_,300,true)
end 
...
if not is_devtaha(msg) then
if msg.forward_info_ and  tahadevIRAQ:get(DEVSTOR..'lock:fwd'..bot_id) then     
return false  end    
if  msg.content_.ID == 'MessagePhoto' and tahadevIRAQ:get(DEVSTOR..'lock:photo'..bot_id) then      
return false  end     
if msg.content_.ID == 'MessageDocument' and  tahadevIRAQ:get(DEVSTOR..'lock:file'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageSticker' and  tahadevIRAQ:get(DEVSTOR..'lock:ste'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageVoice' and  tahadevIRAQ:get(DEVSTOR..'lock:musec'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageContact' and  tahadevIRAQ:get(DEVSTOR..'lock:phon'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageVideo' and  tahadevIRAQ:get(DEVSTOR..'lock:ved'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageAnimation' and  tahadevIRAQ:get(DEVSTOR..'lock:gif'..bot_id) then     
return false  end    
if msg.content_.ID == 'MessageAudio' and  tahadevIRAQ:get(DEVSTOR..'lock:vico'..bot_id) then     
return false  end    
...
if tahadevIRAQ:get(DEVSTOR..'lock:links'..bot_id) then      
return false  end  
end
end  
if not tahadevIRAQ:get(DEVSTOR..'lock:botl'..bot_id) then    
if not is_devtaha(msg) then     
local pvstart = tahadevIRAQ:get(DEVSTOR.."pvstart")    
if pvstart then    
...
if not tahadevIRAQ:sismember(DEVSTOR.."usersbot",msg.chat_id_) then    
tahadevIRAQ:sadd(DEVSTOR.."usersbot",msg.chat_id_)    
local pvstart = tahadevIRAQ:get(DEVSTOR.."pvstart")    
end    
...
if not tahadevIRAQ:sismember(DEVSTOR..'pv:ban'..msg.chat_id_,id_user) then
if data.username_ == false then
local text = '📮¦ العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم حظره من التواصل\n✓'
tahadevIRAQ:incrby('numlocktextpv'..bot_id..id_user,10000000)    tahadevIRAQ:sadd(DEVSTOR..'pv:ban'..msg.chat_id_,id_user) 
...
if tahadevIRAQ:sismember(DEVSTOR..'pv:ban'..msg.chat_id_,id_user) then
if data.username_ == false then
local text = '📮¦ العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره من التواصل\n✓'
tahadevIRAQ:del('numlocktextpv'..bot_id..id_user)    tahadevIRAQ:srem(DEVSTOR..'pv:ban'..msg.chat_id_,id_user)
IRAQmonshn(msg.chat_id_, id_user, msg.id_, text, 16, utf8.len(CatchName(data.first_name_,15)))  
else
zo = '*📮¦ العضــو ↫ ❪ *[@'..data.username_..'] ❫\n*📬¦ تم الغاء حظره من التواصل\n✓*'
tahadevIRAQ:del('numlocktextpv'..bot_id..id_user)    tahadevIRAQ:srem(DEVSTOR..'pv:ban'..msg.chat_id_,id_user)
...
if text == 'فتح الكل' and is_devtaha(msg) then   taha = '*🚸¦* تم فتح جميع الاوامر   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      tahadevIRAQ:del(DEVSTOR..'lock:photo'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:vico'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:ste'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:file'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:phon'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:links'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:ved'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:fwd'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:gif'..bot_id)    tahadevIRAQ:del(DEVSTOR..'lock:musec'..bot_id)    end      
if text == 'قفل الكل' and is_devtaha(msg) then   taha = '*📛¦* تم قفل جميع الاوامر  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      tahadevIRAQ:set(DEVSTOR..'lock:photo'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:vico'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:ste'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:file'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:phon'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:links'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:ved'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:fwd'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:gif'..bot_id,true)    tahadevIRAQ:set(DEVSTOR..'lock:musec'..bot_id,true)     end   
if text == 'فتح الصور' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصور   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:photo'..bot_id) end  
if text == 'قفل الصور' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصور  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:photo'..bot_id,true) end 
if text == 'فتح الصوت' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصوت   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:vico'..bot_id) end  
if text == 'قفل الصوت' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصوت  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:vico'..bot_id,true) end 
if text == 'فتح الاغاني' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الاغاني   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:musec'..bot_id) end  
if text == 'قفل الاغاني' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الاغاني  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:musec'..bot_id,true) end 
if text == 'فتح المتحركه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح المتحركه   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:gif'..bot_id) end  
if text == 'قفل المتحركه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل المتحركه  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:gif'..bot_id,true) end 
if text == 'فتح التوجيه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح التوجيه   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:fwd'..bot_id) end  
if text == 'قفل التوجيه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل التوحيه  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:fwd'..bot_id,true) end 
if text == 'فتح الفيديو' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الفيديو   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:ved'..bot_id) end  
if text == 'قفل الفيديو' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الفيديو  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:ved'..bot_id,true) end 
if text == 'فتح الروابط' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الروابط   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:links'..bot_id) end  
if text == 'قفل الروابط' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الروابط  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:links'..bot_id,true) end 
if text == 'فتح الجهات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الجهات   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:phon'..bot_id) end  
if text == 'قفل الجهات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الجهات  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:phon'..bot_id,true) end 
if text == 'فتح الملفات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملفات   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:file'..bot_id) end  
if text == 'قفل الملفات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملفات  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:file'..bot_id,true) end 
if text == 'فتح الملصقات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملصقات   ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:del(DEVSTOR..'lock:ste'..bot_id) end  
if text == 'قفل الملصقات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملصقات  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  tahadevIRAQ:set(DEVSTOR..'lock:ste'..bot_id,true) end 
if text == 'الاعدادات 🔏' and is_devtaha(msg) then  if tahadevIRAQ:get(DEVSTOR..'lock:photo'..bot_id) then    lock_photo = '* مقفل ✓ *'      else     lock_photo = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:vico'..bot_id) then    lockvic = '* مقفل ✓ *'      else     lockvic = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:ste'..bot_id) then    lockste = '* مقفل ✓ *'      else     lockste = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:file'..bot_id) then    lockfile = '* مقفل ✓ *'     else     lockfile = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:phon'..bot_id) then    lockphon = '* مقفل ✓ *'      else     lockphon = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:links'..bot_id) then    lock_link = '* مقفل ✓ *'      else     lock_link = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:ved'..bot_id) then    lock_vid = '* مقفل ✓ *'      else     lock_vid = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:fwd'..bot_id) then    lock_fwd = '* مقفل ✓ *'      else     lock_fwd = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:gif'..bot_id) then    lock_gif = '* مقفل ✓ *'      else     lock_gif = '*مفتوح ✘*'    end    if tahadevIRAQ:get(DEVSTOR..'lock:musec'..bot_id) then    lock_muse = '* مقفل ✓ *'      else     lock_muse = '*مفتوح ✘*'    end    local text = '*📛¦* اهلا بك في اعدادات الخاص 🍃'..'\n*ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ*\n'..    '\n*📬¦* الروابط '..lock_link..    '\n'..'*📬¦* الصور '..lock_photo..    '\n'..'*📬¦* الاغاني '..lockvic..    '\n'..'*📬¦* الملصقات '..lockste..    '\n'..'*📬¦* الملفات '..lockfile..    '\n'..'*📬¦* الجهات '..lockphon..    '\n'..'*📬¦* الفيديو '..lock_vid..    '\n'..'*📬¦* التوجيه '..lock_fwd..    '\n'..'*📬¦* المتحركه '..lock_gif..    '\n'..'*📬¦* الصوت '..lock_muse..    '\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🚨*¦* اضافه الى ذالك تستطيع قفل وفتح الكل\n🚸*¦* قفل الكل \n🚸*¦* فتح الكل'    IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, text, 1, 'md')     end     
...
if text == 'مسح المحظورين 📢' and is_devtaha(msg) then       local list = tahadevIRAQ:smembers(DEVSTOR..'pv:ban'..msg.chat_id_)   for k,v in pairs(list) do     tahadevIRAQ:del(DEVSTOR..'pv:ban'..msg.chat_id_)   tahadevIRAQ:del('numlocktextpv'..bot_id..v)  end   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📛*¦* تم مسح المحظورين', 1, 'md')     end
if text == 'تفعيل البوت الخدمي 🎮' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل البوت خدمي  ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevIRAQ:del(DEVSTOR..'lock:bot:free'..bot_id) end 
if text == 'تعطيل البوت الخدمي 🚸' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل البوت الخدمي  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevIRAQ:set(DEVSTOR..'lock:bot:free'..bot_id,true) end
if text == 'تفعيل تواصل 📨' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل بوت التواصل  ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevIRAQ:del(DEVSTOR..'lock:botl'..bot_id) end 
if text == 'تعطيل تواصل 📩' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل التواصل  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevIRAQ:set(DEVSTOR..'lock:botl'..bot_id,true) end
...
if text == "وضع اسم البوت ⚡" and is_devtaha(msg) then tahadevIRAQ:setex(DEVSTOR..'namebot:witting'..msg.sender_user_id_,300,true) IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* ارسل لي الاسم 📯\n",1, 'md')  end
if text == 'مسح المميزين عام 🌟' and is_devtaha(msg) then      local list = tahadevIRAQ:smembers(DEVSTOR..'vip:groups')    if #list == 0 then  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مميزين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevIRAQ:srem(DEVSTOR.."vip:groups",v)    num = num + 1  end   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المميزين عام *\n', 1, 'md')   end
if text == 'مسح المطورين 👮' and is_devtaha(msg) then     local list = tahadevIRAQ:smembers(DEVSTOR..'sudo:bot')    if #list == 0 then  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مطورين ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevIRAQ:srem(DEVSTOR.."sudo:bot",v)    num = num + 1  end   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المطورين *\n', 1, 'md')   end
if text == 'مسح قائمه العام 🚷' and is_devtaha(msg) then   local list = tahadevIRAQ:smembers(DEVSTOR..'IRAQ:gbaned')    if #list == 0 then  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    tahadevIRAQ:srem(DEVSTOR.."IRAQ:gbaned",v)    num = num + 1  end   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المحظورين عام *\n', 1, 'md')   end
if text and text:match("^ضع رد تواصل 💻$") and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور 🎐$") and is_devtaha(msg) then tahadevIRAQ:setex(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت 📠$") and is_devtaha(msg) then tahadevIRAQ:setex(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text == 'تفعيل رساله الترحيب 🎌' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل رسالة ترحيب عند الاضافه  ✔' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevIRAQ:del(DEVSTOR..'lock:klsh:add'..bot_id) end 
if text == 'تعطيل رساله الترحيب 📱' and is_devtaha(msg) then taha = '*📮¦*تم تعطيل رسالة ترحيب عند الاضافه  ❌' IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") tahadevIRAQ:set(DEVSTOR..'lock:klsh:add'..bot_id,true) end
if text == "حذف رد التواصل 🔧" and is_devtaha(msg) then  tahadevIRAQ:del(DEVSTOR.."pvstart") IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") end 
if text == "حذف كليشه ستارت 🃏" and is_devtaha(msg) then  tahadevIRAQ:del(DEVSTOR.."start:msgofstart1") IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") end 
if text == "حذف كليشه المطور 🀄" and is_devtaha(msg) then  tahadevIRAQ:del(DEVSTOR.."dev") IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه المطور', 1, "md") end 
if text and text:match("^ضع عدد الاعضاء 📜$") and is_devtaha(msg) then  tahadevIRAQ:setex(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  local t = '*📊¦ ارسل لي العدد الان*'  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') end
if text == "جلب رد التواصل 📚" and is_devtaha(msg) then if tahadevIRAQ:get(DEVSTOR.."pvstart") then pvstart = tahadevIRAQ:get(DEVSTOR.."pvstart") IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(pvstart)..'', 1, 'md')  else  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*✉¦ لا يوجد رد في التواصل \n📮¦* ارسل `ضع رد التواصل`\n🍃', 1, 'md')  end  end
if text == "جلب كليشه ستارت 📚" and is_devtaha(msg) then  local start = tahadevIRAQ:get(DEVSTOR.."start:msgofstart1")  if start then IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(start)..'', 1, 'md') else IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*🎭¦ لم يتم وضع كليشه ستارت *\n', 1, 'md') end end
if text == 'الاحصائيات 🔭' and is_devtaha(msg) then    local grall = tahadevIRAQ:scard(DEVSTOR.."botgps") or 0    local gradd = tahadevIRAQ:scard(DEVSTOR..'bot:gpsby:id') or 0    local uspv = tahadevIRAQ:scard(DEVSTOR.."usersbot") or 0    IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📬¦ عدد المجموعات المفعله ↫ ❪'..gradd..'❫\n💥¦ عدد المشتركين ↫ ❪'..uspv..'❫*\n✓', 1, 'md')   end
if text=="اذاعه بالتوجيه 📬" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للمجموعات\n✓", 1, "md")   end
if text=="اذاعه خاص بالتوجيه 🔮" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للخاص\n✓", 1, "md")   end
if text=="اذاعه عام بالتوجيه 💾" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي التوجيه ليتم اذاعته للكل\n✓", 1, "md")   end
if text=="اذاعه 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى المجموعات\n✓", 1, "md")   end
if text=="اذاعه للكل 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الكل\n✓", 1, "md")   end
if text=="اذاعه خاص 📡" and msg.reply_to_message_id_ == 0 and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* ارسل لي سواء كان » ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الخاص\n✓", 1, "md")   end 
if text ==('المجموعات 📇') and is_devtaha(msg) then    local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')   if #list == 0 then  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*💥¦ لا توجد مجموعات حاليا *\n', 1, 'md')  return false  end local t = '⚡¦* اهلا بك في ايدي المجموعات 🍁*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'    for k,v in pairs(list) do     local nummsg = tonumber(tahadevIRAQ:get(DEVSTOR..'groupmsg:'..v..':'))   numrgroup(v) local numg = (tahadevIRAQ:get(DEVSTOR.."numgrop"..v) or '3')  local namechat = tahadevIRAQ:get(DEVSTOR..'group:name'..v)   if namechat then  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n*« "..namechat..' » ❪'..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     else  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n* ❪"..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     end  file = io.open("IRAQ_groups", "w") file:write([[ ]]..isnothtml(t)..[[ ]]) file:close()   end    t = t..'*📮¦*لعرض معلومات مجموعه معينه\n*💥¦ ارسل كشف من ثم ايدي المجموعه*\n*🚸¦ مثال ❪كشف -10012345667❫*\n꞉'    if #list >= 25 then    local groups = tahadevIRAQ:scard(DEVSTOR..'bot:gpsby:id')    sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './IRAQ_groups','📛¦ عذرا لديك الكثير من المجموعات\n📬¦ تم ارسال المجموعات في الملف\n🚸¦ عدد المجموعات •⊱'..groups..'⊰•',dl_cb, nil)   else   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')    end   end
...
if text == 'مسح المشتركين 💯' and is_devtaha(msg) then     local list = tahadevIRAQ:smembers(DEVSTOR..'usersbot')     local pv = 0  for k,v in pairs(list) do      tahadevIRAQ:srem(DEVSTOR..'usersbot',v)    pv = pv + 1  end     IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*🎲¦ تم مسح » ❪'..pv..'❫ من المشتركين *\n', 1, 'md')   end  
if text == 'مسح المجموعات 💯' and is_devtaha(msg) then   local lgp = tahadevIRAQ:smembers(DEVSTOR.."bot:gpsby:id")   local lsug = tahadevIRAQ:smembers(DEVSTOR.."botgps")   local lgpn = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id")   local lsugn = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id")   for k,v in pairs(lgp) do   rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   for k,v in pairs(lsug) do    rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,"*📮¦* تم مغادره البوت من » ❪"..lsugn.."❫ مجموعات \n✓", 1, 'md')   end
if text == 'المحظورين عام 📑' and is_devtaha(msg) then   local list = tahadevIRAQ:smembers(DEVSTOR..'IRAQ:gbaned')  local t = '*📮¦ قائمه المحظورين عام *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = tahadevIRAQ:get(DEVSTOR.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد محظورين عام في البوت'   end   IRAQ_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text == 'المطورين 📑' and is_devtaha(msg) then   local list = tahadevIRAQ:smembers(DEVSTOR..'sudo:bot')  local t = '*📮¦ قائمه مطورين البوت *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = tahadevIRAQ:get(DEVSTOR.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد مطورين في البوت'   end   IRAQ_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text == 'المميزين عام 📑' and is_devtaha(msg) then   local list = tahadevIRAQ:smembers(DEVSTOR..'vip:groups')  local t = '*📮¦ قائمه المميزين عام *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = tahadevIRAQ:get(DEVSTOR.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد مميزين عام في البوت'   end   IRAQ_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
if text and text:match("^استخراج الرابط 🔦$") and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')  end
if text and text:match("^كشف 🔍$") and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'   IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')  end
end
if chat_type == 'super' then 
if not tahadevIRAQ:sismember(DEVSTOR..'bot:gpsby:id',msg.chat_id_) then
...
if msg.content_.ID == "MessageChatAddMembers" then 
return else
local post_count = tonumber(tahadevIRAQ:get(DEVSTOR..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
...
tahadevIRAQ:setex(DEVSTOR..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_, tonumber(tahadevIRAQ:hget("flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
end 
end
...
tahadevIRAQ:del(DEVSTOR.."lockpin"..msg.chat_id_) 
else
if msg.content_.ID == 'MessagePinMessage' then    
if is_owner(msg) and tahadevIRAQ:get(DEVSTOR.."lockpin"..msg.chat_id_) then    
tahadevIRAQ:set(DEVSTOR..'pinned'..msg.chat_id_, msg.content_.message_id_) 
elseif not tahadevIRAQ:get(DEVSTOR.."lockpin"..msg.chat_id_) then    
tahadevIRAQ:set(DEVSTOR..'pinned'..msg.chat_id_, msg.content_.message_id_)    
end    
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lockpin"..msg.chat_id_) then 
if msg.content_.ID == 'MessagePinMessage' then  
unpinChannelMessage(msg.chat_id_)  
local PinnedMessage = tahadevIRAQ:get(DEVSTOR..'pinned'..msg.chat_id_)  
...
if tahadevIRAQ:get(DEVSTOR..'lock:text'..msg.chat_id_) then       
delete_msg(msg.chat_id_,{[0] = msg.id_})   
return false end    
end     
---الاشعارات
if msg.content_.ID == "MessageChatDeletePhoto" or msg.content_.ID == "MessageChatChangePhoto" or msg.content_.ID == 'MessagePinMessage' or msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" or msg.content_.ID == 'MessageChatChangeTitle' or msg.content_.ID == "MessageChatDeleteMember" then   
if tahadevIRAQ:get(DEVSTOR..'lock:tagservr'..msg.chat_id_) then  
delete_msg(msg.chat_id_,{[0] = msg.id_})       
end    
end   
---الاضافات والدخول
if msg.content_.ID == "MessageChatAddMembers" and not is_vipgroup(msg) then   
if tahadevIRAQ:get(DEVSTOR.."lock:AddMempar"..msg.chat_id_) == 'kick' then
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
...
if tahadevIRAQ:get(DEVSTOR.."lock:Join"..msg.chat_id_) == 'kick' then
...
if tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "del" and not is_vipgroup(msg) then    
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then    
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then    
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" and not is_vipgroup(msg) then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ked" and not is_vipgroup(msg) then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "kick" and not is_vipgroup(msg) then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ktm" and not is_vipgroup(msg) then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Photo"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Video"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Animation"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:geam"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Audio"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:vico"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Keyboard"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Sticker"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif tahadevIRAQ:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif tahadevIRAQ:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif tahadevIRAQ:get(DEVSTOR.."lock:forward"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Document"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Unsupported"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not is_vipgroup(msg) then
if tahadevIRAQ:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Markdaun"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if tahadevIRAQ:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "del" then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "kick" then
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Contact"..msg.chat_id_) == "ktm" then
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "del" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ked" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
ked(msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "kick" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
kicck(msg,msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
elseif tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ktm" and utf8.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,msg.sender_user_id_)
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.ID == 'MessagePinMessage' then
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:PINMSG'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
local PinnedMessage = tahadevIRAQ:get(DEVSTOR..'pinned'..msg.chat_id_)  
if PinnedMessage then  
pinChannelMessage(msg.chat_id_,tonumber(PinnedMessage),0) 
end
...
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") or msg.content_.caption_:match(".[Pp][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.content_.caption_:match("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]/") or msg.content_.caption_:match("[Tt].[Mm][Ee]/") then 
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:LINKS'..msg.chat_id_,msg.sender_user_id_) then
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
end
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or text and text:match("[Hh][Tt][Tt][Pp][Ss]://") or text and text:match("[Hh][Tt][Tt][Pp]://") or text and text:match("[Ww][Ww][Ww].") or text and text:match(".[Cc][Oo][Mm]") or text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") or text and text:match(".[Pp][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or text and text:match("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]/") or text and text:match("[Tt].[Mm][Ee]/") and not is_vipgroup(msg) then
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:LINKS'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
-- المعرفات
if text and text:match("@[%a%d_]+") or text and text:match("@(.+)") and not is_owner(msg) then     
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:USERNAME'..msg.chat_id_,msg.sender_user_id_) then
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
if msg.content_.caption_ and not is_owner(msg) then  
...
-- الصور
if msg.content_.ID == 'MessagePhoto' then 
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:PHOTO'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
-- الصوت
if msg.content_.ID == 'MessageVoice' or msg.content_.ID == 'MessageAudio' then
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:VICO'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
...
--المتحركه
if msg.content_.ID == 'MessageAnimation' then
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:GIF'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
--الفيديو
if msg.content_.ID == 'MessageVideo' then
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:VIDEO'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
--الملصقات
if msg.content_.ID == 'MessageSticker' then     
print('ملصق')
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:STEKR'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
--السيبفي
if msg.content_.ID == "MessageUnsupported" then
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:SELPHY'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
--الماركداون
...
if msg.content_.entities_[0] then 
if msg.content_.entities_[0] and msg.content_.entities_[0].ID == "MessageEntityUrl" or msg.content_.entities_[0].ID == "MessageEntityTextUrl" then      
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:MARKDWN'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
end
...
--التوجيه
if msg.forward_info_ then
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:FWD'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end
--الاونلاين
if msg.reply_markup_ and msg.reply_markup_.ID == 'ReplyMarkupInlineKeyboard' then     
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:INLIN'..msg.chat_id_,msg.sender_user_id_) and not is_owner(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_, message_ids_={[0] = msg.id_}}, dl_cb, nil) 
end
end 
 
local status_welcome = (tahadevIRAQ:get(DEVSTOR..'add:welc:'..msg.chat_id_) or 'rem')  
if status_welcome == 'add' and not tahadevIRAQ:get(DEVSTOR..'lock:tagservr'..msg.chat_id_)  then
if msg.content_.ID == "MessageChatJoinByLink" then
if not is_banned(msg.chat_id_,msg.sender_user_id_) then 
function wlc(extra,result,success) 
if tahadevIRAQ:get(DEVSTOR..'welcome:'..msg.chat_id_) then 
t = tahadevIRAQ:get(DEVSTOR..'welcome:'..msg.chat_id_) 
else  
t = '\n• نورت حبي \n•  name \n• ngp' 
end 
t = t:gsub('name','<IRAQ>'..CatchName(result.first_name_,25)..'</IRAQ>') 
t = t:gsub('ngp',tahadevIRAQ:get(DEVSTOR..'group:name'..msg.chat_id_)) 
...
tahadevIRAQ:set(DEVSTOR.."lock:text"..msg.chat_id_,true) 
...
tahadevIRAQ:setex(DEVSTOR.."set:description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📋¦* ارسل النص الذي تريده '  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text and text:match("^ضع ترحيب$") and is_mod(msg) then  
tahadevIRAQ:setex(DEVSTOR.."welc:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📃¦* ارسل النص الذي تريده '  
local tt = '\n*📬¦* ايضا يمكنك وضع \n*📛¦* دالة طباعه الاسم `name` \n*📛¦* ودالة طباعه اسم المجموعه `ngp`'
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t..tt, 1, 'md') 
end
if text and text:match("^جلب صوره$") and not tahadevIRAQ:get(DEVSTOR.."lock:get:photo"..msg.chat_id_) then  
tahadevIRAQ:setex(DEVSTOR.."photo:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
...
local list = tahadevIRAQ:smembers(DEVSTOR.."rep:media"..msg.chat_id_)  
local taha = tahadevIRAQ:scard(DEVSTOR.."rep:media"..msg.chat_id_)  
for k,v in pairs(list) do  
tahadevIRAQ:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:gif"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:vico"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:stekr"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."taha:"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:photo"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:video"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:document"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:audio"..v..msg.chat_id_)  
tahadevIRAQ:srem(DEVSTOR.."rep:media"..msg.chat_id_,v)  
end  
...
for k,v in pairs(list) do  
if tahadevIRAQ:get(DEVSTOR.."addreply1:gif"..v..msg.chat_id_) then
taha = 'متحركه 🎆'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:vico"..v..msg.chat_id_)  then
taha = 'بصمه 🎵'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:stekr"..v..msg.chat_id_)  then
taha = 'ملصق 🃏'
elseif tahadevIRAQ:get(DEVSTOR.."taha:"..v..msg.chat_id_) then
taha = 'رساله 💭'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:photo"..v..msg.chat_id_)  then
taha = 'صوره 🌇'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:video"..v..msg.chat_id_)  then
taha = 'فيديو 📹'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:document"..v..msg.chat_id_)  then
taha = 'ملف 📁'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:audio"..v..msg.chat_id_)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end  
...
tahadevIRAQ:set(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  end    
if text then   
local tsssst = tahadevIRAQ:get(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if tahadevIRAQ:sismember(DEVSTOR..'rep:media'..msg.chat_id_,text) then
...
tahadevIRAQ:set(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"repp")  
tahadevIRAQ:set(DEVSTOR.."addreply2:"..msg.sender_user_id_..msg.chat_id_, text)  
tahadevIRAQ:sadd(DEVSTOR.."rep:media"..msg.chat_id_,text)  
end
return false  end  
end  
if text and text == 'حذف رد بالرد' and  is_monsh(msg) then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = tahadevIRAQ:get(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
if test and test == 'reppp' then   
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if not tahadevIRAQ:sismember(DEVSTOR..'rep:media'..msg.chat_id_,text) then
tahadevIRAQ:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
...
tahadevIRAQ:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:gif"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:vico"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:stekr"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."taha:"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:photo"..text..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:video"..text..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:document"..text..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:audio"..text..msg.chat_id_)
tahadevIRAQ:srem(DEVSTOR.."rep:media"..msg.chat_id_,text)  
end
return false  end  
end
...
tahadevIRAQ:del(DEVSTOR.."addreply1:"..msg.sender_user_id_..msg.chat_id_)  
local test = tahadevIRAQ:get(DEVSTOR.."addreply2:"..msg.sender_user_id_..msg.chat_id_)  
if msg.content_.sticker_ then   
tahadevIRAQ:set(DEVSTOR.."addreply1:stekr"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
tahadevIRAQ:set(DEVSTOR.."addreply1:vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
tahadevIRAQ:set(DEVSTOR.."addreply1:gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
tahadevIRAQ:set(DEVSTOR.."taha:"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
tahadevIRAQ:set(DEVSTOR.."addreply1:audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevIRAQ:set(DEVSTOR.."addreply1:document"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevIRAQ:set(DEVSTOR.."addreply1:video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
tahadevIRAQ:set(DEVSTOR.."addreply1:video:caption"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
tahadevIRAQ:set(DEVSTOR.."addreply1:photo"..test..msg.chat_id_, photo_in_group)  
tahadevIRAQ:set(DEVSTOR.."addreply1:photo:caption"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
tahadevIRAQ:del(DEVSTOR.."addreply2:"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text and msg.reply_to_message_id_ ~= 0 and not tahadevIRAQ:get(DEVSTOR..'lock:rep:rd'..msg.chat_id_) then  
local anemi = tahadevIRAQ:get(DEVSTOR.."addreply1:gif"..text..msg.chat_id_)   
local veico = tahadevIRAQ:get(DEVSTOR.."addreply1:vico"..text..msg.chat_id_)   
local stekr = tahadevIRAQ:get(DEVSTOR.."addreply1:stekr"..text..msg.chat_id_)     
local taha = tahadevIRAQ:get(DEVSTOR.."taha:"..text..msg.chat_id_)   
local photo = tahadevIRAQ:get(DEVSTOR.."addreply1:photo"..text..msg.chat_id_)
local photo_caption = (tahadevIRAQ:get(DEVSTOR.."addreply1:photo:caption"..text..msg.chat_id_) or '' )
local video = tahadevIRAQ:get(DEVSTOR.."addreply1:video"..text..msg.chat_id_)
local video_caption = tahadevIRAQ:get(DEVSTOR.."addreply1:video:caption"..text..msg.chat_id_)
local document = tahadevIRAQ:get(DEVSTOR.."addreply1:document"..text..msg.chat_id_)
local audio = tahadevIRAQ:get(DEVSTOR.."addreply1:audio"..text..msg.chat_id_)
if taha then    
...
local list = tahadevIRAQ:smembers(DEVSTOR.."repmedia"..msg.chat_id_)  
local taha = tahadevIRAQ:scard(DEVSTOR.."repmedia"..msg.chat_id_)  
for k,v in pairs(list) do  
tahadevIRAQ:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply1:gif"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply1:vico"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply1:stekr"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply:rd"..v..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:photo:gp"..v..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:video:gp"..v..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:document:gp"..v..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:audio:gp"..v..msg.chat_id_)
tahadevIRAQ:srem(DEVSTOR.."repmedia"..msg.chat_id_,v)  
end  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* المجموعه تحتوي على *{"..taha.."}* رد \n*📮¦* تم مسح الردود جميعها \n", 1, 'md')  
end
...
for k,v in pairs(list) do  
if tahadevIRAQ:get(DEVSTOR.."add:reply1:gif"..v..msg.chat_id_) then
taha = 'متحركه 🎆'
elseif tahadevIRAQ:get(DEVSTOR.."add:reply1:vico"..v..msg.chat_id_) then
taha = 'بصمه 🎙'
elseif tahadevIRAQ:get(DEVSTOR.."add:reply1:stekr"..v..msg.chat_id_) then
taha = 'ملصق 🃏'
elseif tahadevIRAQ:get(DEVSTOR.."add:reply:rd"..v..msg.chat_id_) then
taha = 'رساله 💭'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:photo:gp"..v..msg.chat_id_) then
taha = 'صوره 🌇'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:video:gp"..v..msg.chat_id_) then
taha = 'فيديو 📹'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:document:gp"..v..msg.chat_id_) then
taha = 'ملف 📁'
elseif tahadevIRAQ:get(DEVSTOR.."addreply1:audio:gp"..v..msg.chat_id_) then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n', 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = tahadevIRAQ:get(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
return false  end 
if tahadevIRAQ:sismember(DEVSTOR..'repmedia'..msg.chat_id_,text) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"repp")  
tahadevIRAQ:set(DEVSTOR.."add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
tahadevIRAQ:sadd(DEVSTOR.."repmedia"..msg.chat_id_,text)  
end
return false  end  
end
if text == 'حذف رد' and is_monsh(msg) then   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n', 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = tahadevIRAQ:get(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == 'reppp' then   
if not tahadevIRAQ:sismember(DEVSTOR..'repmedia'..msg.chat_id_,text) then
tahadevIRAQ:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦ الكلمه » {* ["..text.."] *} 🍃\n⚡¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ الكلمه » {* ["..text.."] *} 🍃\n📬¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
tahadevIRAQ:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply1:gif"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply1:vico"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply1:stekr"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."add:reply:rd"..text..msg.chat_id_)  
tahadevIRAQ:del(DEVSTOR.."addreply1:photo:gp"..text..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:video:gp"..text..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:document:gp"..text..msg.chat_id_)
tahadevIRAQ:del(DEVSTOR.."addreply1:audio:gp"..text..msg.chat_id_)
tahadevIRAQ:srem(DEVSTOR.."repmedia"..msg.chat_id_,text)  
end
return false  end  
end
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📌¦ تم حفظ الردَ الخاص پك\n📨¦ نو؏ الرد — { '..what..' }*', 1, 'md')  
tahadevIRAQ:del(DEVSTOR.."add:reply1"..msg.sender_user_id_..msg.chat_id_)  
local test = tahadevIRAQ:get(DEVSTOR.."add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if msg.content_.sticker_ then   
tahadevIRAQ:set(DEVSTOR.."add:reply1:stekr"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
tahadevIRAQ:set(DEVSTOR.."add:reply1:vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
tahadevIRAQ:set(DEVSTOR.."add:reply1:gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
tahadevIRAQ:set(DEVSTOR.."add:reply:rd"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
tahadevIRAQ:set(DEVSTOR.."addreply1:audio:gp"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevIRAQ:set(DEVSTOR.."addreply1:document:gp"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevIRAQ:set(DEVSTOR.."addreply1:video:gp"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
tahadevIRAQ:set(DEVSTOR.."addreply1:video:caption:gp"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
tahadevIRAQ:set(DEVSTOR.."addreply1:photo:gp"..test..msg.chat_id_, photo_in_group)  
tahadevIRAQ:set(DEVSTOR.."addreply1:photo:caption:gp"..test..msg.chat_id_,(msg.content_.caption_ or ''))  
end
tahadevIRAQ:del(DEVSTOR.."add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
if text and not tahadevIRAQ:get(DEVSTOR..'lock:rep'..msg.chat_id_) then  
local anemi = tahadevIRAQ:get(DEVSTOR.."add:reply1:gif"..text..msg.chat_id_)   
local veico = tahadevIRAQ:get(DEVSTOR.."add:reply1:vico"..text..msg.chat_id_)   
local stekr = tahadevIRAQ:get(DEVSTOR.."add:reply1:stekr"..text..msg.chat_id_)     
local taha = tahadevIRAQ:get(DEVSTOR.."add:reply:rd"..text..msg.chat_id_)   
local video_caption = tahadevIRAQ:get(DEVSTOR.."addreply1:video:caption:gp"..text..msg.chat_id_)
local photo_caption = (tahadevIRAQ:get(DEVSTOR.."addreply1:photo:caption:gp"..text..msg.chat_id_) or '' )
local photo = tahadevIRAQ:get(DEVSTOR.."addreply1:photo:gp"..text..msg.chat_id_)
local video = tahadevIRAQ:get(DEVSTOR.."addreply1:video:gp"..text..msg.chat_id_)
local document = tahadevIRAQ:get(DEVSTOR.."addreply1:document:gp"..text..msg.chat_id_)
local audio = tahadevIRAQ:get(DEVSTOR.."addreply1:audio:gp"..text..msg.chat_id_)
if taha then    
...
if tahadevIRAQ:get(DEVSTOR..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تفعيل ردود المطور بالرد *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:rep:all:rd'..bot_id)   
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تعطيل ردود المطور بالرد *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:rep:all:rd'..bot_id,true)   
else
...
local list = tahadevIRAQ:smembers(DEVSTOR.."rep:media:all:rd"..bot_id)    
local taha = tahadevIRAQ:scard(DEVSTOR.."rep:media:all:rd"..bot_id)    
for k,v in pairs(list) do    
tahadevIRAQ:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:repallt:gif:all:rd"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tvico:all:rd"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tstekr:all:rd"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:text:all:rd"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."all:addreply1:photo:gp"..v..bot_id)
tahadevIRAQ:del(DEVSTOR.."all:addreply1:video:gp"..v..bot_id)
tahadevIRAQ:del(DEVSTOR.."all:addreply1:document:gp"..v..bot_id)
tahadevIRAQ:del(DEVSTOR.."all:addreply1:audio:gp"..v..bot_id)
tahadevIRAQ:srem(DEVSTOR.."rep:media:all:rd"..bot_id,v)    
end    
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* المجموعه تحتوي على *{"..taha.."}* رد \n*📮¦* تم مسح الردود جميعها \n", 1, 'md')    
end
...
for k,v in pairs(list) do    
if tahadevIRAQ:get(DEVSTOR.."add:repallt:gif:all:rd"..v..bot_id) then
taha = 'متحركه 🎆'
elseif tahadevIRAQ:get(DEVSTOR.."add:rep:tvico:all:rd"..v..bot_id) then
taha = 'بصمه 🎙'
elseif tahadevIRAQ:get(DEVSTOR.."add:rep:tstekr:all:rd"..v..bot_id)  then
taha = 'ملصق 🃏'
elseif tahadevIRAQ:get(DEVSTOR.."add:rep:text:all:rd"..v..bot_id) then
taha = 'رساله 💭'
elseif tahadevIRAQ:get(DEVSTOR.."all:addreply1:photo:gp"..v..bot_id)  then
taha = 'صوره 🌇'
elseif tahadevIRAQ:get(DEVSTOR.."all:addreply1:video:gp"..v..bot_id)  then
taha = 'فيديو 📹'
elseif tahadevIRAQ:get(DEVSTOR.."all:addreply1:document:gp"..v..bot_id)  then
taha = 'ملف 📁'
elseif tahadevIRAQ:get(DEVSTOR.."all:addreply1:audio:gp"..v..bot_id)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end    
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes')    
return false    end      
if text then     
local tt = tahadevIRAQ:get(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
if tt == 'yes' then     
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
return false  end 
if tahadevIRAQ:sismember(DEVSTOR.."rep:media:all:rd"..bot_id,text) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes1')    
tahadevIRAQ:set(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id, text)    
tahadevIRAQ:sadd(DEVSTOR.."rep:media:all:rd"..bot_id,text)    
end
return false    end    
end
if text and text == 'حذف رد بالرد عام' and  is_devtaha(msg) then     
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id,'yes11')    
return false    end    
--للكل بالرد
if text then 
local test = tahadevIRAQ:get(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
if test and test == 'yes11' then     
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
return false  end 
if not tahadevIRAQ:sismember(DEVSTOR..'rep:media:all:rd'..bot_id,text) then
tahadevIRAQ:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*🎫¦ الكلمه » {* ["..text.."] *} 🍂\n📮¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📌¦ الكلمه » {* ["..text.."] *} 🍂\n💢¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
tahadevIRAQ:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:repallt:gif:all:rd"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tvico:all:rd"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tstekr:all:rd"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:text:all:rd"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."all:addreply1:photo:gp"..text..bot_id)
tahadevIRAQ:del(DEVSTOR.."all:addreply1:video:gp"..text..bot_id)
tahadevIRAQ:del(DEVSTOR.."all:addreply1:document:gp"..text..bot_id)
tahadevIRAQ:del(DEVSTOR.."all:addreply1:audio:gp"..text..bot_id)
tahadevIRAQ:srem(DEVSTOR.."rep:media:all:rd"..bot_id,text)    
end
return false    end    
end
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📌¦ تم حفظ الردَ الخاص پك\n📨¦ نو؏ الرد — { '..what..' }*', 1, 'md')  
tahadevIRAQ:del(DEVSTOR.."add:repallt:rd"..msg.sender_user_id_..bot_id)    
local test = tahadevIRAQ:get(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
if msg.content_.sticker_ then     
tahadevIRAQ:set(DEVSTOR.."add:rep:tstekr:all:rd"..test..bot_id, msg.content_.sticker_.sticker_.persistent_id_)    
end     
if msg.content_.voice_ then    
tahadevIRAQ:set(DEVSTOR.."add:rep:tvico:all:rd"..test..bot_id, msg.content_.voice_.voice_.persistent_id_)    
end     
if msg.content_.animation_ then     
tahadevIRAQ:set(DEVSTOR.."add:repallt:gif:all:rd"..test..bot_id, msg.content_.animation_.animation_.persistent_id_)    
end    
if text then     
tahadevIRAQ:set(DEVSTOR.."add:rep:text:all:rd"..test..bot_id, text)    
end    
if msg.content_.audio_ then
tahadevIRAQ:set(DEVSTOR.."all:addreply1:audio:gp"..test..bot_id, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevIRAQ:set(DEVSTOR.."all:addreply1:document:gp"..test..bot_id, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevIRAQ:set(DEVSTOR.."all:addreply1:video:gp"..test..bot_id, msg.content_.video_.video_.persistent_id_)  
tahadevIRAQ:set(DEVSTOR.."all:addreply1:video:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
tahadevIRAQ:set(DEVSTOR.."all:addreply1:photo:gp"..test..bot_id, photo_in_group)  
tahadevIRAQ:set(DEVSTOR.."all:addreply1:photo:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
tahadevIRAQ:del(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
return false    
end    
end
if text and msg.reply_to_message_id_ ~= 0 and not tahadevIRAQ:get(DEVSTOR..'lock:rep:all:rd'..bot_id) then   
local anemi = tahadevIRAQ:get(DEVSTOR.."add:repallt:gif:all:rd"..text..bot_id)    
local veico = tahadevIRAQ:get(DEVSTOR.."add:rep:tvico:all:rd"..text..bot_id)    
local stekr = tahadevIRAQ:get(DEVSTOR.."add:rep:tstekr:all:rd"..text..bot_id)      
local taha = tahadevIRAQ:get(DEVSTOR.."add:rep:text:all:rd"..text..bot_id)    
local video_caption = tahadevIRAQ:get(DEVSTOR.."all:addreply1:video:caption:gp"..text..bot_id)
local photo_caption = (tahadevIRAQ:get(DEVSTOR.."all:addreply1:photo:caption:gp"..text..bot_id) or '' )
local photo = tahadevIRAQ:get(DEVSTOR.."all:addreply1:photo:gp"..text..bot_id)
local video = tahadevIRAQ:get(DEVSTOR.."all:addreply1:video:gp"..text..bot_id)
local document = tahadevIRAQ:get(DEVSTOR.."all:addreply1:document:gp"..text..bot_id)
local audio = tahadevIRAQ:get(DEVSTOR.."all:addreply1:audio:gp"..text..bot_id)
if taha then     
IRAQ_sendMsg(msg.chat_id_, msg.reply_to_message_id_, 1, ''..check_markdown(taha)..'', 1, 'md')      
return false    
end     
...
if tahadevIRAQ:get(DEVSTOR..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تفعيل ردود المطور *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:rep:all'..bot_id)   
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تعطيل ردود المطور *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:rep:all'..bot_id,true)   
else
...
local list = tahadevIRAQ:smembers(DEVSTOR.."rep:media:all"..bot_id)    
local taha = tahadevIRAQ:scard(DEVSTOR.."rep:media:all"..bot_id)    
for k,v in pairs(list) do    
tahadevIRAQ:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:repallt:gif:all"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tvico:all"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tstekr:all"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:text:all"..v..bot_id)    
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:photo:gp"..v..bot_id)
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:video:gp"..v..bot_id)
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:document:gp"..v..bot_id)
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:audio:gp"..v..bot_id)
tahadevIRAQ:srem(DEVSTOR.."rep:media:all"..bot_id,v)    
...
t = "*📮¦ قائمة ردود المطور 🍃\nٴ━━━━━━━━━━━*\n"    
for k,v in pairs(list) do    
if tahadevIRAQ:get(DEVSTOR.."add:repallt:gif:all"..v..bot_id) then
taha = 'متحركه 🎆'
elseif tahadevIRAQ:get(DEVSTOR.."add:rep:tvico:all"..v..bot_id) then
taha = 'بصمه 🎙'
elseif tahadevIRAQ:get(DEVSTOR.."add:rep:tstekr:all"..v..bot_id) then
taha = 'ملصق 🃏'
elseif tahadevIRAQ:get(DEVSTOR.."add:rep:text:all"..v..bot_id) then
taha = 'رساله 💭'
elseif tahadevIRAQ:get(DEVSTOR.."mall:addreply1:photo:gp"..v..bot_id)  then
taha = 'صوره 🌇'
elseif tahadevIRAQ:get(DEVSTOR.."mall:addreply1:video:gp"..v..bot_id)  then
taha = 'فيديو 📹'
elseif tahadevIRAQ:get(DEVSTOR.."mall:addreply1:document:gp"..v..bot_id)  then
taha = 'ملف 📁'
elseif tahadevIRAQ:get(DEVSTOR.."mall:addreply1:audio:gp"..v..bot_id)  then
taha = 'اغنيه 🎵'
end
t = t..'*'..k..'• *❨`'..v..'`❩ *» {'..taha..'}*\n'    
end    
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id,'yes')    
return false    end      
if text then    
local tt = tahadevIRAQ:get(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
if tt == 'yes' then     
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
return false  end 
if tahadevIRAQ:sismember(DEVSTOR.."rep:media:all"..bot_id,text) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ لقد تم اضافة رد بهاذه الكلمه \n📬¦ ارسل كلمه اخرى او ارسل الغاء*\n🍃\n", 1, 'md')  
else
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› ملف ‹› فيديو }'
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ حسنآ ارسل الرد الان\n📤¦ يمكنك ارسال الرد » "..media.."*\n🍃", 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id,'yes1')    
tahadevIRAQ:set(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id, text)    
tahadevIRAQ:sadd(DEVSTOR.."rep:media:all"..bot_id,text)    
end
return false    end    
end
if text and text == 'حذف رد عام' and  is_devtaha(msg) then     
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ حسنآ ارسل لي الكلمه الان *\n💥', 1, 'md')  
tahadevIRAQ:set(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id,'yes11')    
return false    end    
if text then 
local test = tahadevIRAQ:get(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
if test and test == 'yes11' then   
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
return false  end   
if not tahadevIRAQ:sismember(DEVSTOR..'rep:media:all'..bot_id,text) then
tahadevIRAQ:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*🎫¦ الكلمه » {* ["..text.."] *} 🍂\n📮¦ لا يوجد رد بهاذه الكلمه*\n💥\n", 1, 'md')  
tahadevIRAQ:del(DEVSTOR.."add:repallt:gif:all"..text..bot_id)    tahadevIRAQ:del(DEVSTOR.."add:rep:tvico:all"..text..bot_id)    tahadevIRAQ:del(DEVSTOR.."add:rep:tstekr:all"..text..bot_id)    tahadevIRAQ:del(DEVSTOR.."add:rep:text:all"..text..bot_id) tahadevIRAQ:srem("rep:media:all"..bot_id,text) 
else
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📌¦ الكلمه » {* ["..text.."] *} 🍂\n💢¦ تم حذفها من قائمة الردود *\n💥\n", 1, 'md')  
tahadevIRAQ:del(DEVSTOR.."add:repallt"..msg.sender_user_id_..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:repallt:gif:all"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tvico:all"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:tstekr:all"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."add:rep:text:all"..text..bot_id)    
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:photo:gp"..text..bot_id)
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:video:gp"..text..bot_id)
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:document:gp"..text..bot_id)
tahadevIRAQ:del(DEVSTOR.."mall:addreply1:audio:gp"..text..bot_id)
tahadevIRAQ:srem(DEVSTOR.."rep:media:all"..bot_id,text)    
end
return false    end    
end    
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
...
local test = tahadevIRAQ:get(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
if msg.content_.sticker_ then     
tahadevIRAQ:set(DEVSTOR.."add:rep:tstekr:all"..test..bot_id, msg.content_.sticker_.sticker_.persistent_id_)    
end     
if msg.content_.voice_ then    
tahadevIRAQ:set(DEVSTOR.."add:rep:tvico:all"..test..bot_id, msg.content_.voice_.voice_.persistent_id_)    
end     
if msg.content_.animation_ then     
tahadevIRAQ:set(DEVSTOR.."add:repallt:gif:all"..test..bot_id, msg.content_.animation_.animation_.persistent_id_)    
end    
if text then     
tahadevIRAQ:set(DEVSTOR.."add:rep:text:all"..test..bot_id, text)    
end    
if msg.content_.audio_ then
tahadevIRAQ:set(DEVSTOR.."mall:addreply1:audio:gp"..test..bot_id, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
tahadevIRAQ:set(DEVSTOR.."mall:addreply1:document:gp"..test..bot_id, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
tahadevIRAQ:set(DEVSTOR.."mall:addreply1:video:gp"..test..bot_id, msg.content_.video_.video_.persistent_id_)  
tahadevIRAQ:set(DEVSTOR.."mall:addreply1:video:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
tahadevIRAQ:set(DEVSTOR.."mall:addreply1:photo:gp"..test..bot_id, photo_in_group)  
tahadevIRAQ:set(DEVSTOR.."mall:addreply1:photo:caption:gp"..test..bot_id,(msg.content_.caption_ or ''))  
end
tahadevIRAQ:del(DEVSTOR.."addreply2:"..msg.sender_user_id_..bot_id)    
return false    end    
end
if text and not tahadevIRAQ:get(DEVSTOR..'lock:rep:all'..bot_id) then    
local anemi = tahadevIRAQ:get(DEVSTOR.."add:repallt:gif:all"..text..bot_id)    
local veico = tahadevIRAQ:get(DEVSTOR.."add:rep:tvico:all"..text..bot_id)    
local stekr = tahadevIRAQ:get(DEVSTOR.."add:rep:tstekr:all"..text..bot_id)      
local taha = tahadevIRAQ:get(DEVSTOR.."add:rep:text:all"..text..bot_id)    
local video_caption = tahadevIRAQ:get(DEVSTOR.."mall:addreply1:video:caption:gp"..text..bot_id)
local photo_caption = (tahadevIRAQ:get(DEVSTOR.."mall:addreply1:photo:caption:gp"..text..bot_id) or '' )
local photo = tahadevIRAQ:get(DEVSTOR.."mall:addreply1:photo:gp"..text..bot_id)
local video = tahadevIRAQ:get(DEVSTOR.."mall:addreply1:video:gp"..text..bot_id)
local document = tahadevIRAQ:get(DEVSTOR.."mall:addreply1:document:gp"..text..bot_id)
local audio = tahadevIRAQ:get(DEVSTOR.."mall:addreply1:audio:gp"..text..bot_id)
if taha then     
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, ''..check_markdown(taha)..'', 1, 'md')      
return false    end     
if veico then     
...
local group = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')   
local w = 0
local q = 0
for i = 1, #group do
...
tahadevIRAQ:srem(DEVSTOR.."bot:gpsby:id",group[i])  
rem_group(group[i])   
...
local pv = tahadevIRAQ:smembers(DEVSTOR..'usersbot')   
local sendok = 0
for i = 1, #pv do
...
tahadevIRAQ:srem(DEVSTOR.."usersbot",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if tahadevIRAQ:get(DEVSTOR.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
tahadevIRAQ:del(DEVSTOR..'id:gp'..msg.chat_id_)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
tahadevIRAQ:del(DEVSTOR.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(.*)") 
local iduserr = tahadevIRAQ:get(DEVSTOR..'id:gp'..msg.chat_id_)  
...
tahadevIRAQ:set(DEVSTOR..'id:gp'..msg.chat_id_,taha)  
tahadevIRAQ:setex(DEVSTOR.."bc:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📊¦ ارسل لي النص الذي تريده*'  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text then 
if is_mod(msg) then
if text == 'ارسال نسخه' and is_devtaha(msg) then  sendDocument(SUDO, 0, 0, 1, nil, './IRAQ.lua', '🚸¦اسم الملف ( IRAQ.lua )\n♻¦عدد المشتركين ( '..(tahadevIRAQ:scard(DEVSTOR.."usersbot") or 0)..' )\n📮¦عدد المجموعات ( '..(tahadevIRAQ:scard(DEVSTOR.."botgps") or 0)..' )',dl_cb, nil)  end
...
local pv = tahadevIRAQ:scard(DEVSTOR.."usersbot")      
...
local grp = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id")       
...
local grall = tahadevIRAQ:scard(DEVSTOR.."botgps") or 0  
local gradd = tahadevIRAQ:scard(DEVSTOR..'bot:gpsby:id') or 0  
local uspv = tahadevIRAQ:scard(DEVSTOR.."usersbot") or 0  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*\n📬¦ عدد المجموعات المفعله ↫ ❪'..gradd..'❫\n💥¦ عدد المشتركين ↫ ❪'..uspv..'❫*\n✓', 1, 'md') 
end
...
local pv = 0
for k,v in pairs(list) do    
tahadevIRAQ:srem(DEVSTOR..'usersbot',v)  
pv = pv + 1
end   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*🎲¦ تم مسح » ❪'..pv..'❫ من المشتركين *\n', 1, 'md') 
end  
if text ==  ""..NAMEBOT..' غادر' and is_owner(msg) then 
tahadevIRAQ:srem(DEVSTOR.."addgrop", msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true) 
rem_group(msg.chat_id_)  
rem_lockal(msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR.."test:group"..msg.chat_id_)   
tahadevIRAQ:del(DEVSTOR..'moder'..msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR..'modergroup'..msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR..'mods:'..msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true) 
tahadevIRAQ:srem(DEVSTOR..'bot:gpsby:id', msg.chat_id_)  
tahadevIRAQ:srem(DEVSTOR.."botgps", msg.chat_id_)   
changeChatMemberStatus(msg.chat_id_, bot_id, "Left") 
...
local list = tahadevIRAQ:smembers(DEVSTOR..'tedmembars'..msg.chat_id_) 
local pv = 0
for k,v in pairs(list) do   
tahadevIRAQ:del(DEVSTOR..'tedmembars'..msg.chat_id_) 
tahadevIRAQ:srem(DEVSTOR.."keed", msg.chat_id_)  
...
return false  end
if kk.id_ then  
local msgss = tonumber(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..kk.id_) or 0)  
...
t = 'مطور اساسي'
elseif tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',kk.id_) then
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,kk.id_) then
t = 'المنشئ'
elseif tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,kk.id_) then
t = 'المدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,kk.id_) then
t = 'الادمن'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:groups',kk.id_) then
t = 'مميز عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,kk.id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',kk.id_) then
kkeed = 'محظور عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,kk.id_) then
kkeed = 'محظور'
elseif tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,kk.id_) then
kkeed = 'مكتوم'
elseif tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,kk.id_) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
'` ❫\n⭐*¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..kk.id_) or 0)..
...
local msgss = tonumber(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..iduser) or 0)  
...
t = 'مطور اساسي'
elseif tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',iduser) then
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,iduser) then
t = 'المنشئ'
elseif tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,iduser) then
t = 'المدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,iduser) then
t = 'الادمن'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:groups',iduser) then
t = 'مميز عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,iduser) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',iduser) then
kkeed = 'محظور عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,iduser) then
kkeed = 'محظور'
elseif tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,iduser) then
kkeed = 'مكتوم'
elseif tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,iduser) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..iduser) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
local msgss = tonumber(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..result.sender_user_id_) or 0)  
...
t = 'مطور اساسي'
elseif tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',result.sender_user_id_) then
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_) then
t = 'المنشئ'
elseif tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_) then
t = 'المدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_) then
t = 'الادمن'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:groups',result.sender_user_id_) then
t = 'مميز عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',result.sender_user_id_) then
kkeed = 'محظور عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'محظور'
elseif tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'مكتوم'
elseif tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
kkeed = 'مقيد'
else
kkeed = 'لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..result.sender_user_id_) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
local msgss = tonumber(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..tes.content_.entities_[0].user_id_) or 0)  
...
t = 'مطور اساسي'
elseif tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',tes.content_.entities_[0].user_id_) then
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'المنشئ'
elseif tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'المدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'الادمن'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:groups',tes.content_.entities_[0].user_id_) then
t = 'مميز عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
t = 'عضو مميز'
else
t = 'مجرد عضو'
end
...
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',tes.content_.entities_[0].user_id_) then
kkeed = 'محظور عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'محظور'
elseif tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'مكتوم'
elseif tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,tes.content_.entities_[0].user_id_) then
kkeed = 'مقيد'
else
kkeed = ' لا يوجد'
end
...
' }❫\n⭐¦ رتبـة الكروب » ❪ '..rtpa..
' ❫\n🎖¦ رتبـة البوت » ❪ '..t..
' ❫\n📨¦ رسـائله » ❪ '..(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..tes.content_.entities_[0].user_id_) or 0)..
' ❫\n🗳¦ تفــاعله » ❪ '..formsgg(msgss)..' ❫'..photouser1..
'\n🚸¦ نوع القيود » ❪ '..kkeed..
' ❫\n🔹¦ التواجد » ❪ '..tt..
' ❫\n⚡¦ نوع حسابه » ❪ '..acca..' ❫'
...
tahadevIRAQ:setex(DEVSTOR.."get:link:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text and text:match("^معلومات$") and is_devtaha(msg) then  
tahadevIRAQ:setex(DEVSTOR.."get:info:gp" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي ايدي المجموعه*\n💥'  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == 'الكروبات' and is_sudo(msg) then 
local t = tahadevIRAQ:scard(DEVSTOR.."botgps")
local y = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id") 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ العدد الكلي للكروبات هو » ❪'..(y)..'❫* \n', 1, 'md') 
end
if text == 'المشتركين' and is_sudo(msg) then     
local addgrop = tahadevIRAQ:scard(DEVSTOR.."usersbot") or 0    
...
tahadevIRAQ:setex(DEVSTOR.."numadd:bot" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📊¦ ارسل لي العدد الان*'  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == 'مسح المجموعات' and is_devtaha(msg) then 
local lgp = tahadevIRAQ:smembers(DEVSTOR.."bot:gpsby:id") 
local lsug = tahadevIRAQ:smembers(DEVSTOR.."botgps") 
local lgpn = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id") 
local lsugn = tahadevIRAQ:scard(DEVSTOR.."bot:gpsby:id") 
...
tahadevIRAQ:sadd(DEVSTOR..'mods:'..msg.chat_id_,admins[i].user_id_) 
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_
},function(arg,b) 
if b.username_ == true then
tahadevIRAQ:set(DEVSTOR.."user:Name"..b.id_,"@"..b.username_)
end
if b.first_name_ == false then
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,admins[i].user_id_) 
end
end,nil)   
else
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,admins[i].user_id_) 
...
tahadevIRAQ:srem(DEVSTOR..'moder'..msg.chat_id_,owner_id) 
return false  end
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
tahadevIRAQ:sadd(DEVSTOR..'moder'..msg.chat_id_,owner_id) 
end
end
tdcli_function ({ID = "GetUser",user_id_ = owner_id
},function(arg,b) 
...
tahadevIRAQ:set(DEVSTOR..'group:name'..msg.chat_id_,name)
end
end,nil) 
end
...
tahadevIRAQ:set(DEVSTOR.."link:group"..msg.chat_id_, 'setlinkwai') 
end
if text == "الرابط" then 
local link = tahadevIRAQ:get(DEVSTOR.."link:group"..msg.chat_id_)            
if link then                              
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*ٴ📮¦ »* رابط مجموعة ↓\n*ٴ📬¦ » '..tahadevIRAQ:get(DEVSTOR..'group:name'..msg.chat_id_)..' *\n*ٴ📛¦* » ['..link..']\n💥', 1, 'md')                          
else                
...
tahadevIRAQ:del(DEVSTOR.."link:group" .. msg.chat_id_)       
end
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then 
tahadevIRAQ:setex(DEVSTOR.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevIRAQ:setex(DEVSTOR.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevIRAQ:setex(DEVSTOR.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevIRAQ:setex(DEVSTOR.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevIRAQ:setex(DEVSTOR.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevIRAQ:setex(DEVSTOR.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevIRAQ:setex(DEVSTOR.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
tahadevIRAQ:del(DEVSTOR.."rules:group" .. msg.chat_id_) 
end
if text and text:match("^القوانين$") then 
local rules = tahadevIRAQ:get(DEVSTOR.."rules:group" .. msg.chat_id_)   
if rules then     
...
tahadevIRAQ:srem(DEVSTOR..'bot:gps',gp) 
tahadevIRAQ:srem(DEVSTOR..'bot:gpsby:id',gp) 
tahadevIRAQ:srem(DEVSTOR.."botgps",gp) 
tahadevIRAQ:del(DEVSTOR..'mod:'..gp) 
tahadevIRAQ:del(DEVSTOR..'moder'..gp) 
tahadevIRAQ:del(DEVSTOR..'banned:'..gp) 
tahadevIRAQ:del(DEVSTOR.."add:bot:group"..gp) 
tahadevIRAQ:del(DEVSTOR.."setmoder:"..gp) 
tahadevIRAQ:del(DEVSTOR.."gps:settings:"..gp) 
tahadevIRAQ:del(DEVSTOR.."gps:settings:"..gp) 
...
tahadevIRAQ:set(DEVSTOR..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_,true) 
...
for k,v in pairs(list) do   
local nummsg = tonumber(tahadevIRAQ:get(DEVSTOR..'groupmsg:'..v..':')) 
numrgroup(v) local numg = (tahadevIRAQ:get(DEVSTOR.."numgrop"..v) or '3')
local namechat = tahadevIRAQ:get(DEVSTOR..'group:name'..v) 
if namechat then
...
if #list >= 25 then  
local groups = tahadevIRAQ:scard(DEVSTOR..'bot:gpsby:id')  
...
local hash = tahadevIRAQ:get(DEVSTOR..'add:welc:'..msg.chat_id_)     
if hash == 'add' then     
return '✓'     
else     
return '✘'     
...
if tahadevIRAQ:get(DEVSTOR..'lock:tagservrbot'..msg.chat_id_) then
lock_tagservr_bot = '✓'
else 
lock_tagservr_bot = '✘'    
end
...
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..msg.chat_id_) then    
lock_edit = '✓'
else 
lock_edit = '✘'    
end
if tahadevIRAQ:get(DEVSTOR..'lock:edit:media'..msg.chat_id_) then    
lock_edit_med = '✓'
else 
lock_edit_med = '✘'    
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then
lock_links = '✓'
elseif tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ked" then
lock_links = 'بالتقيد 🔏'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "ktm" then
lock_links = 'بالكتم 🔇'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "kick" then
lock_links = 'بالطرد 🚷'    
else
lock_links = '✘'    
end
if tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = '✓'
elseif tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = 'بالتقيد 🔏'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = 'بالكتم 🔇'   
elseif tahadevIRAQ:get(DEVSTOR.."lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = 'بالطرد 🚷'    
else
lock_cmds = '✘'    
end
if tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" then
lock_user = '✓'
elseif tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ked" then
lock_user = 'بالتقيد 🔏'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "ktm" then
lock_user = 'بالكتم 🔇'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "kick" then
lock_user = 'بالطرد 🚷'    
else
lock_user = '✘'    
end
if tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = '✓'
elseif tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = 'بالتقيد 🔏'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = 'بالكتم 🔇'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = 'بالطرد 🚷'    
else
lock_hash = '✘'    
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'del' then
lock_bots = '✓'
elseif tahadevIRAQ:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'ked' then
lock_bots = 'بالتقيد 🔏'   
elseif tahadevIRAQ:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'kick' then
lock_bots = 'بالطرد 🚷'    
else
lock_bots = '✘'    
end
...
if tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = '✓'
elseif tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = 'بالتقيد 🔏'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = 'بالكتم 🔇'    
elseif tahadevIRAQ:get(DEVSTOR.."lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = 'بالطرد 🚷'    
else
lock_spam = '✘'    
end        
...
tahadevIRAQ:del(DEVSTOR..'add:ch:id')
tahadevIRAQ:del(DEVSTOR..'add:ch:username')
taha = "*📮¦ تم تعطيل الاشتراك الاجباري *\n✓"
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "الاشتراك الاجباري" and is_devtaha(msg) then  
if tahadevIRAQ:get(DEVSTOR..'add:ch:username') then
local addchusername = tahadevIRAQ:get(DEVSTOR..'add:ch:username')
...
local getwelcom = tahadevIRAQ:get(DEVSTOR..'welcome:'..msg.chat_id_)  
if getwelcom then 
...
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
tahadevIRAQ:sadd(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد هو مميز'   
tahadevIRAQ:sadd(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز للـكروب\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'vip:group'..msg.chat_id_,user)  
seavusername(user) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
tahadevIRAQ:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.sender_user_id_)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
tahadevIRAQ:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز'   
tahadevIRAQ:srem(DEVSTOR..'vip:group'..msg.chat_id_,result.id_)  
end
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
tahadevIRAQ:srem(DEVSTOR..'vip:group'..msg.chat_id_,user)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
...
tahadevIRAQ:sadd(DEVSTOR..'vip:groups',result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not tahadevIRAQ:sismember(DEVSTOR..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام البوت'   
tahadevIRAQ:sadd(DEVSTOR..'vip:groups',result.id_)  
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مميز عام'   
tahadevIRAQ:sadd(DEVSTOR..'vip:groups',result.id_)  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'vip:groups',user) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز عام البوت\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'vip:groups',user)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام البوت'   
tahadevIRAQ:sadd(DEVSTOR..'vip:groups',user)  
seavusername(user) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'vip:groups',result.sender_user_id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
tahadevIRAQ:srem(DEVSTOR..'vip:groups',result.sender_user_id_)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevIRAQ:sismember(DEVSTOR..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
tahadevIRAQ:srem(DEVSTOR..'vip:groups',result.id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز عام'   
tahadevIRAQ:srem(DEVSTOR..'vip:groups',result.id_)  
end
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'vip:groups',user) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'vip:groups',user)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
tahadevIRAQ:srem(DEVSTOR..'vip:groups',user)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
tahadevIRAQ:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مدير'   
tahadevIRAQ:sadd(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مدير للـكروب\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'modergroup'..msg.chat_id_,user)  
seavusername(user) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
tahadevIRAQ:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.sender_user_id_)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
tahadevIRAQ:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مدير'   
tahadevIRAQ:srem(DEVSTOR..'modergroup'..msg.chat_id_,result.id_)  
end
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
tahadevIRAQ:srem(DEVSTOR..'modergroup'..msg.chat_id_,user)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ادمن'   
tahadevIRAQ:sadd(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'mods:'..msg.chat_id_,user)  
seavusername(user) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,result.sender_user_id_)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس ادمن'   
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,result.id_)  
end
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,user)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
tahadevIRAQ:sadd(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_)  
else
...
return false  end
if result.id_ then  
if not tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو منشئ'   
tahadevIRAQ:sadd(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه منشئ للـكروب\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
tahadevIRAQ:sadd(DEVSTOR..'moder'..msg.chat_id_,user)  
seavusername(user) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
tahadevIRAQ:srem(DEVSTOR..'moder'..msg.chat_id_,result.sender_user_id_)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
tahadevIRAQ:srem(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس منشئ'   
tahadevIRAQ:srem(DEVSTOR..'moder'..msg.chat_id_,result.id_)  
end
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n'   
IRAQmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
tahadevIRAQ:srem(DEVSTOR..'moder'..msg.chat_id_,user)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
tahadevIRAQ:sadd(DEVSTOR..'sudo:bot',result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
tahadevIRAQ:sadd(DEVSTOR..'sudo:bot',result.id_)  
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مطور'   
tahadevIRAQ:sadd(DEVSTOR..'sudo:bot',result.id_)  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
tahadevIRAQ:sadd(DEVSTOR..'sudo:bot',user)  
seavusername(user) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
tahadevIRAQ:srem(DEVSTOR..'sudo:bot',result.sender_user_id_)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
tahadevIRAQ:srem(DEVSTOR..'sudo:bot',result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مطور'   
tahadevIRAQ:srem(DEVSTOR..'sudo:bot',result.id_)  
end
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
tahadevIRAQ:srem(DEVSTOR..'sudo:bot',user)  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
if tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) or tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) or tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم رفع قيوده\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
tahadevIRAQ:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
tahadevIRAQ:srem(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_)   
tahadevIRAQ:srem(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
tahadevIRAQ:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,user) or tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,user) or tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم رفع قيوده\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
tahadevIRAQ:srem(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
tahadevIRAQ:srem(DEVSTOR..'IRAQ:baned'..msg.chat_id_,user)   
tahadevIRAQ:srem(DEVSTOR..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
tahadevIRAQ:srem(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) or tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.id_) or tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم رفع قيوده\n🍃'   
...
tahadevIRAQ:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) 
tahadevIRAQ:srem(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.id_)   
tahadevIRAQ:srem(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_)   
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'IRAQ:baned'..msg.chat_id_,user)   
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره\n🍃'   
tahadevIRAQ:srem(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.id_)   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
for k, v in pairs(list) do 
local taha = tahadevIRAQ:get(DEVSTOR.."user:Name" .. v)
if taha then
local username = taha
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروبات\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:gbaned',result.sender_user_id_)   
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,result.sender_user_id_) end
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره عام من الكروبات\n🍃'   
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,result.sender_user_id_) end
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:gbaned',result.sender_user_id_)   
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n🍃', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره عام من الكروبات\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:gbaned',result.id_)   
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,result.id_) end
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره عام من الكروبات\n🍃'     
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:gbaned',result.id_)   
...
zo = '*📬¦ العضــو » ❪ '..user..' ❫\n🚸¦ تـم حظره عام من الكروبات\n🍃*'   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,user) end
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:gbaned',user)   
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروبات\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,user) end
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'IRAQ:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevIRAQ:srem(DEVSTOR..'IRAQ:gbaned',result.sender_user_id_)   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'IRAQ:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevIRAQ:srem(DEVSTOR..'IRAQ:gbaned',user)   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'IRAQ:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
tahadevIRAQ:srem(DEVSTOR..'IRAQ:gbaned',result.id_)   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم الغاء حظره عام\n🍃'   
tahadevIRAQ:srem(DEVSTOR..'IRAQ:gbaned',result.id_)   
...
if not tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*📬¦* تـم كتمه من الكروب\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
return false  end 
if not tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم كتمه من الكروب\n🍃'     
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
...
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,user)   
seavusername(user) 
...
if tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:srem(DEVSTOR..'mutes'..msg.chat_id_,user)   
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء كتمه\n🍃'   
tahadevIRAQ:srem(DEVSTOR..'mutes'..msg.chat_id_,result.id_)   
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
if not is_owner(msg) and not is_canban(msg) and tahadevIRAQ:get(DEVSTOR..'LOCK:BAN:KICK'..msg.chat_id_) then 
IRAQ_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع الحظر لقد تم تعطيل { الحظر - الطرد } \n👨🏻‍✈️*")   
return false  end 
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:BAN'..msg.chat_id_,msg.sender_user_id_) then
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.id_)   
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره من الكروب\n🍃'     
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:baned'..msg.chat_id_,result.id_)   
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'IRAQ:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:baned'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:baned'..msg.chat_id_,user)   
seavusername(user) 
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ بالتاكيد تـم طرده من الكروب\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:kick'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* بالتاكيد تـم طرده من الكروب\n🍃'   
seavusername(result.sender_user_id_) 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم طرده من الكروب\n🍃'     
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:kick'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم طرده من الكروب\n🍃'     
tahadevIRAQ:sadd(DEVSTOR..'IRAQ:kick'..msg.chat_id_,user)   
seavusername(user) 
...
if not tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
tahadevIRAQ:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
tahadevIRAQ:sadd(DEVSTOR..'mutes'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
return false  end 
if not tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
tahadevIRAQ:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) 
tahadevIRAQ:set(DEVSTOR.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم تقييده من الكروب\n🍃'     
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
...
return false  end
if not tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تقييده من الكروب\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
tahadevIRAQ:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
tahadevIRAQ:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,user) 
...
if tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
IRAQmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
IRAQmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء تقييده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
tahadevIRAQ:srem(DEVSTOR..'tedmembars'..msg.chat_id_,result.id_) 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
if tahadevIRAQ:sismember(DEVSTOR..'filters:'..msg.chat_id_,taha) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ الكلمه » ❪ '..taha..' ❫*\n*📪¦* بالتأكيد تم منع هاذه الكلمه \n💥', 1, 'md') 
else
tahadevIRAQ:sadd(DEVSTOR..'filters:'..msg.chat_id_,taha) 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ الكلمه » ❪ '..taha..' ❫*\n*💠¦* تم منع ارسال هاذه الكلمه \n✓', 1, 'md') 
end
end 
if text and text:match('^الغاء المنع (.*)')  and is_mod(msg) then  
local taha = text:match('^الغاء المنع (.*)') 
if not tahadevIRAQ:sismember(DEVSTOR..'filters:'..msg.chat_id_,taha) then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*⚜¦ الكلمه » ❪ '..taha..' ❫*\n*🗳¦* بالتأكيد تم الغاء منع الكلمه\n💥', 1, 'md') 
else
tahadevIRAQ:srem(DEVSTOR..'filters:'..msg.chat_id_,taha) 
...
if text ==('مسح قائمه المنع') and is_mod(msg) then tahadevIRAQ:del(DEVSTOR..'filters:'..msg.chat_id_) IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📇*¦* تم مسح قائمه المنع', 1, 'md') end 
if text == ('قائمه المنع') and is_mod(msg) then  
local list = tahadevIRAQ:smembers(DEVSTOR..'filters:'..msg.chat_id_) 
...
if tahadevIRAQ:sismember(DEVSTOR..'lock:pin',msg.chat_id_) and not is_monsh(msg) then
IRAQ_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* التثبيت مقفل في المجموعه \n🍃", 1, 'md')  
return false  end
if tahadevIRAQ:sismember(DEVSTOR..'LOCK:PINMSG'..msg.chat_id_,msg.sender_user_id_) then
...
if text == 'اطردني' and not tahadevIRAQ:get(DEVSTOR.."lock:kickme"..msg.chat_id_)   then 
tdcli_function ({
ID = "GetChatMember",
chat_id_ = msg.chat_id_,
user_id_ = msg.sender_user_id_},
...
tahadevIRAQ:del(DEVSTOR..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
return false  end 
if IRAQ1(msg.chat_id_,msg.sender_user_id_) then 
if tonumber(msg.sender_user_id_) == tonumber(SUDO) then
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'sudo:bot',msg.sender_user_id_) then
t = 'المطور'
elseif tahadevIRAQ:sismember(DEVSTOR..'moder'..msg.chat_id_,msg.sender_user_id_) then
t = 'المنشئ'
elseif tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,msg.sender_user_id_) then
t = 'المدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,msg.sender_user_id_) then
t = 'الادمن'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:groups',msg.sender_user_id_) then
t = 'مميز عام'
elseif tahadevIRAQ:sismember(DEVSTOR..'vip:group'..msg.chat_id_,msg.sender_user_id_) then
t = 'مميز'
else
t = ' '
end
...
tahadevIRAQ:set(DEVSTOR..hash, "waite") 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '📮*¦* رائع الان يمكنك تطبيق الشروط\n⚀*¦* ارسل ❪ نعم ❫ ليتم طردك\n*⚁¦* ارسل ❪ لا ❫ لالغاء طردك\n💥', 1, 'md') 
end,nil)
end 
if text then 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if text:match("^نعم$") and tahadevIRAQ:get(DEVSTOR..hash) == "waite" then 
tahadevIRAQ:set(DEVSTOR..hash, "نعم") 
elseif text:match("^لا$") and tahadevIRAQ:get(DEVSTOR..hash) == "waite" then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦* حسنآ لن يتم طردك من هنا\n💭', 1, 'md') 
tahadevIRAQ:del(DEVSTOR..hash, true) 
end 
end 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if tahadevIRAQ:get(DEVSTOR..hash) then 
if tahadevIRAQ:get(DEVSTOR..hash) == "نعم" then 
if IRAQ1(msg.chat_id_,msg.sender_user_id_) then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* عذرا انت ❪ '..get_mok(msg.chat_id_,msg.sender_user_id_)..' ❫ لا استطيع طردك \n🍃', 1, 'md') 
else  
kick(msg,msg.chat_id_,msg.sender_user_id_)  
...
if text == 'نزلني' and not tahadevIRAQ:get(DEVSTOR.."lock:demrtpa"..msg.chat_id_)   then 
local hash = 'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_ tahadevIRAQ:set(DEVSTOR..hash, "waite") 
...
tahadevIRAQ:del(DEVSTOR..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true)  
else  
...
if tahadevIRAQ:get(DEVSTOR..hash) then 
if tahadevIRAQ:get(DEVSTOR..hash) == "نعم" then 
tahadevIRAQ:srem(DEVSTOR..'modergroup'..msg.chat_id_,msg.sender_user_id_)  
tahadevIRAQ:srem(DEVSTOR..'mods:'..msg.chat_id_,msg.sender_user_id_) 
tahadevIRAQ:srem(DEVSTOR..'vip:group'..msg.chat_id_,msg.sender_user_id_) 
...
tahadevIRAQ:set(DEVSTOR..'add:mepr:'..msg.chat_id_,true) 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,"📮❯ تم تفعيل الاضافه اجباري", 1, 'md') 
end 
end
if text == "تعطيل الاضافه" and is_owner(msg) then 
tahadevIRAQ:del(DEVSTOR..'add:mepr:'..msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR..'meaddwy:'..msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR..'meaddtaha:'..msg.chat_id_) 
local taha = tahadevIRAQ:keys("addedtaha:*") 
for i=1,#taha do tahadevIRAQ:del(DEVSTOR..taha[i]) 
end 
...
tahadevIRAQ:set(DEVSTOR..'setadd:'..msg.chat_id_,numadded) 
...
local nummsg = tonumber(tahadevIRAQ:get(DEVSTOR..'groupmsg:'..msg.chat_id_..':')) 
local nummsgg = tahadevIRAQ:get(DEVSTOR..'groupmsg:'..msg.chat_id_..':') 
...
if text and text:match("^مشاهده منشور$") then tahadevIRAQ:set(DEVSTOR..'viewchannel'..msg.sender_user_id_,true) IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, '♼*¦* حسننا ارسل التوجيه من القناة سارسل عدد المشاهدات', 1, 'md') end 
if text and text:match("^ضع رد تواصل$") and is_devtaha(msg) then   tahadevIRAQ:setex(DEVSTOR.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور$") and is_devtaha(msg) then tahadevIRAQ:setex(DEVSTOR.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت$") and is_devtaha(msg) then tahadevIRAQ:setex(DEVSTOR.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if msg.content_.ID == 'MessageChatChangeTitle' then tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,data)  tahadevIRAQ:set(DEVSTOR..'group:name'..msg.chat_id_,data.title_) end,nil)  end
...
IRAQ_sendMsg(msg.chat_id_,msg.id_, 1, "*📬¦* تم وضع اسم للمجموعه \n", 1, 'md')  
tahadevIRAQ:set(DEVSTOR..'group:name'..result.chat_id_,result.content_.text_)
end
end,nil) 
end 
...
if tahadevIRAQ:get(DEVSTOR..'lock:rep:rd'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل الردود بالرد *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:rep:rd'..msg.chat_id_)  
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:rep:rd'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل الردود بالرد *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:rep:rd'..msg.chat_id_,true)   
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:rep'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل الردود *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:rep'..msg.chat_id_)  
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:rep'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل الردود *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:rep'..msg.chat_id_,true)   
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:id'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الايدي *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:id'..msg.chat_id_) 
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:id'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل الايدي *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:id'..msg.chat_id_,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:id:photo'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الايدي *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:id:photo'..msg.chat_id_) 
tahadevIRAQ:del(DEVSTOR..'lock:id'..msg.chat_id_) 
else
taha = '*📮¦ بالتاكيد تم تفعيل الايدي  *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
if not tahadevIRAQ:get(DEVSTOR..'lock:id:photo'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل الايدي بالصوره *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:id:photo'..msg.chat_id_,true) 
tahadevIRAQ:set(DEVSTOR..'lock:id'..msg.chat_id_,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:get:photo'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل امر جلب الصور *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:get:photo'..msg.chat_id_) 
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:get:photo'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل امر جلب الصور *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:get:photo'..msg.chat_id_,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:kickme'..msg.chat_id_)  then
taha = '*??¦ تم تفعيل امر اطردني *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:kickme'..msg.chat_id_) 
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:kickme'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل امر اطردني *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:kickme'..msg.chat_id_,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:demrtpa'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل امر نزلني *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:demrtpa'..msg.chat_id_) 
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:demrtpa'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل امر نزلني *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:demrtpa'..msg.chat_id_,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:bot:free'..bot_id) then
taha = '*📮¦ تم تفعيل البوت الخدمي *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:bot:free'..bot_id) 
else
...
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:bot:free'..bot_id,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:klsh:add'..bot_id) then
taha = '*📮¦ تم تفعيل كليشه الترحيب عند الاضافه*\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:klsh:add'..bot_id) 
else
...
if not tahadevIRAQ:get(DEVSTOR..'lock:klsh:add'..bot_id) then
taha = '*📮¦ تم تعطيل كليشه الترحيب عند الاضافه*\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:klsh:add'..bot_id,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'lock:botl'..bot_id) then
taha = '*📮¦ تم تفعيل البوت التواصل *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'lock:botl'..bot_id) 
else
...
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'lock:botl'..bot_id,true) 
else
...
if tahadevIRAQ:get(DEVSTOR..'LOCK:BAN:KICK'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل { الحظر - الطرد } *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:del(DEVSTOR..'LOCK:BAN:KICK'..msg.chat_id_) 
else
...
if not tahadevIRAQ:get(DEVSTOR..'LOCK:BAN:KICK'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل { الحظر - الطرد } *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevIRAQ:set(DEVSTOR..'LOCK:BAN:KICK'..msg.chat_id_,true) 
else
taha = '*📮¦ بالتاكيد تم تعطيل { الحظر - الطرد } *\n✓' 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
end
end
if text and text:match("^صورتي (%d+)") and not tahadevIRAQ:get(DEVSTOR.."lock:get:photo"..msg.chat_id_)  then 
...
local dev = tahadevIRAQ:get(DEVSTOR.."dev") 
if dev then 
...
tahadevIRAQ:del(DEVSTOR.."pvstart") 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") 
end 
if text == "حذف كليشه ستارت" and is_devtaha(msg) then  
tahadevIRAQ:del(DEVSTOR.."start:msgofstart1") 
IRAQ_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") 
end 
if text == 'معلوماتي' or text=='موقعي' or text == 'اكشفني' then 
local msgtaha = 500 
local msggstaha = tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0  
local nupmsgg =  tonumber((msggstaha / msgtaha) * 100)   
local msguser = tonumber(tahadevIRAQ:get(DEVSTOR..'msg:user:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
local tahamsg = (tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if is_devtaha(msg) then 
t = 'مطور اساسي 🌟'  
elseif is_sudo(msg) then 
t = 'مطور البوت ✨'  
...
local whatnumadded = (tahadevIRAQ:get(DEVSTOR..'setadd:'..msg.chat_id_) or 0) 
...
local getmsgs = tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local taha = '\n*📨¦ عدد رسائلك » ❪ '..getmsgs..' ❫ رساله\n📮¦ تم مسح جميع رسائلك *\n🍃'  
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md')  
tahadevIRAQ:del(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) 
end
...
if text == "تفاعلي" then
local msguser = tonumber(tahadevIRAQ:get(DEVSTOR..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
taha = '*📮¦ تفاعلك هنا » ❪ '..formsgg(msguser)..' ❫\n🍃*'
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "جهاتي" then
local addmempar = tonumber(tahadevIRAQ:get(DEVSTOR..'add:mempar'..msg.chat_id_..':'..msg.sender_user_id_) or 0) 
if addmempar == 0 then
...
tahadevIRAQ:setex(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
local tahaid= [[
*📮¦ اهلا عزيزي المطور 
...
tahadevIRAQ:del(DEVSTOR.."KLISH:ID")
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,  '*📮¦ تم مسح كليشه الايدي *\n', 1, 'md')
return false  
end 
if tahadevIRAQ:get(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
tahadevIRAQ:del(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  end 
tahadevIRAQ:del(DEVSTOR.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
...
tahadevIRAQ:set(DEVSTOR.."KLISH:ID",CHENGER_ID)
...
NUMPGAME = (tahadevIRAQ:get(DEVSTOR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
...
if not tahadevIRAQ:get(DEVSTOR..'lock:id'..msg.chat_id_) then      
local get_id_text = tahadevIRAQ:get(DEVSTOR.."KLISH:ID")
if get_id_text then
...
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  tahadevIRAQ:set(DEVSTOR..'pinned'..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = result.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusEditor" or da and da.status_.ID == "ChatMemberStatusCreator" then
tahadevIRAQ:sadd(DEVSTOR..'LOCK:PINMSG'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:PINMSG'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من التثبيت هنا\n',result.id_)   
else
if tahadevIRAQ:sismember(DEVSTOR..'modergroup'..msg.chat_id_,result.id_) then
tt = 'مدير'
elseif tahadevIRAQ:sismember(DEVSTOR..'mods:'..msg.chat_id_,result.id_) then
tt = 'ادمن'
else
tt = 'عضو'
end
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:PINMSG'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:PINMSG'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع التثبيت عنه \n',result.id_)   
end    
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:STEKR'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:STEKR'..msg.chat_id_,result.id_)     
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:STEKR'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:STEKR'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الملصقات عنه\n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:PHOTO'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:PHOTO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الصور هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:PHOTO'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:PHOTO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الصور عنه\n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:INLIN'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:INLIN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الاونلاين هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:INLIN'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:INLIN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الاونلاين عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:FWD'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:FWD'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال التوجيه هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:FWD'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:FWD'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع التوجيه عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:LINKS'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:LINKS'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الروابط هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:LINKS'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:LINKS'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الروابط عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:SELPHY'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:SELPHY'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال السيلفي هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:SELPHY'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:SELPHY'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع السيلفي عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:VICO'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:VICO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الصوت هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:VICO'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:VICO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الصوت عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:VIDEO'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:VIDEO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الفيديو هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:VIDEO'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:VIDEO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الفيديو عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:MARKDWN'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:MARKDWN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الماركداون هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:MARKDWN'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:MARKDWN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الماركداون عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:GIF'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:GIF'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال المتحركه هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:GIF'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:GIF'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع المتحركه عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:USERNAME'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:USERNAME'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال المعرفات هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:USERNAME'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:USERNAME'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع المعرفات عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'LOCK:BAN'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'LOCK:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من » ( طرد - حظر ) المستخدمين\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'LOCK:BAN'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:srem(DEVSTOR..'LOCK:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منعه من ( طرد - حظر ) المستخدمين \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:sadd(DEVSTOR..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tahadevIRAQ:srem(DEVSTOR..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
...
tahadevIRAQ:sadd(DEVSTOR..'SET:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منحه صلاحية ( طرد - حظر ) المستخدمين \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
tahadevIRAQ:srem(DEVSTOR..'SET:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منحه صلاحية ( طرد - حظر ) المستخدمين\n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
if text ==('مسح صلاحيات الحظر') and is_owner(msg) then 
local list = tahadevIRAQ:smembers(DEVSTOR..'SET:BAN'..msg.chat_id_) 
if #list == 0 then
IRAQ_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد اعضاء لديهم صلاحياة الحظر ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
tahadevIRAQ:srem(DEVSTOR..'SET:BAN'..msg.chat_id_,v) 
num = num + 1
end 
...
tahadevIRAQ:srem(DEVSTOR..'bot:gpsby:id',idch) 
tahadevIRAQ:srem(DEVSTOR.."bot:gpsby:id:add",idch) 
tahadevIRAQ:srem(DEVSTOR.."bot:gps:id", idch) 
tdcli_function({ID="GetChat",chat_id_ = '-100'..data.channel_.id_},function(arg,data)  linkgp = tahadevIRAQ:get(DEVSTOR.."link:group"..idch)  
...
rem_group('-100'..data.channel_.id_)   
tahadevIRAQ:sadd(DEVSTOR..'botgps','-100'..data.channel_.id_) 
elseif data.channel_.status_.ID == "ChatMemberStatusEditor" then   
local tahach = '-100'..data.channel_.id_
if tahadevIRAQ:sismember(DEVSTOR..'bot:gpsby:id:add','-100'..data.channel_.id_)  then  
print('\27[30;33m»» THE GROUP IS HAS BEEN ADD ↓\n»» '..'-100'..data.channel_.id_..'\n\27[1;37m')
else 
print('\27[30;35m»» THE BOT IS ADMIEN AND ADD GROUP ↓\n»» '..'-100'..data.channel_.id_..'\n\27[1;37m')
add_group('-100'..data.channel_.id_)   
tahadevIRAQ:sadd(DEVSTOR..'bot:gpsby:id','-100'..data.channel_.id_)   
tahadevIRAQ:sadd(DEVSTOR.."botgps",'-100'..data.channel_.id_)  
tahadevIRAQ:sadd(DEVSTOR.."bot:gpsby:id:add",'-100'..data.channel_.id_)  
tahadevIRAQ:set(DEVSTOR.."test:group"..'-100'..data.channel_.id_,'IRAQ')    
tahadevIRAQ:set(DEVSTOR.."add:bot:group"..'-100'..data.channel_.id_, true)   
end
return false 
end  
end
...
tahadevIRAQ:srem(DEVSTOR.."bot:gpsby:id:add",msg.chat_id_)  
tahadevIRAQ:srem(DEVSTOR.."botgps",msg.chat_id_)  
tahadevIRAQ:srem(DEVSTOR..'bot:gpsby:id',msg.chat_id_)   
return false
end
...
kick(msg,msg.chat_id_,msg.sender_user_id_) 
delete_msg(msg.chat_id_, {[0] = msg.id_}) 
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,msg.sender_user_id_) end
return false 
end
...
kick(msg,msg.chat_id_,msg.content_.members_[0].id_) 
delete_msg(msg.chat_id_, {[0] = msg.id_})  
local list = tahadevIRAQ:smembers(DEVSTOR..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,msg.content_.members_[0].id_) end
end 
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and tahadevIRAQ:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'del'  and not is_vipgroup(msg) then  
...
if msg.content_.ID == "MessageChatDeleteMember" and tahadevIRAQ:get(DEVSTOR..'lock:tagservrbot'..msg.chat_id_) then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end 
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and tahadevIRAQ:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'ked' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
tahadevIRAQ:sadd(DEVSTOR..'tedmembars'..msg.chat_id_,msg.sender_user_id_)
end  
...
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and tahadevIRAQ:get(DEVSTOR.."lock:Bot:kick"..msg.chat_id_) == 'kick' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
...
if tahadevIRAQ:get(DEVSTOR..'lock:edit:media'..data.chat_id_) then 
...
if txxt:find("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") and tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Pp][Ee]") and tahadevIRAQ:get(DEVSTOR..'lock:links'..msg.chat_id_) then 
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") and tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]/") and tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt].[Mm][Ee]/") and tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Ww][Ww][Ww].") and tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Cc][Oo][Mm]") then
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) and tahadevIRAQ:get(DEVSTOR.."lock:Link"..msg.chat_id_) == "del" then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find('@[%a%d_]+') and tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" then
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('@(.+)') and tahadevIRAQ:get(DEVSTOR.."lock:user:name"..msg.chat_id_) == "del" then
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#[%a%d_]+') and tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" then
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#(.+)') and tahadevIRAQ:get(DEVSTOR.."lock:hashtak"..msg.chat_id_) == "del" then
if tahadevIRAQ:get(DEVSTOR..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
...
tahadevIRAQ:srem(DEVSTOR..'botgps',v) 
changeChatMemberStatus(v, bot_id, "Left")
rem_group(v)   
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
...
tahadevIRAQ:set(DEVSTOR..'group:name'..v,data.title_)
